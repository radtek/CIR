...
{
#if false
    public class VoCirDetailsHandlerTest
    {
        ...
        public VoCirDetailsHandlerTest()
        {
        ...
        public async Task ValidResponse()
        {
            ...
            var content = JsonConvert.DeserializeObject<VoCirDetailsDto>(await result.Content.ReadAsStringAsync());
