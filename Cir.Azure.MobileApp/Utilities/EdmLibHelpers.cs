...
namespace System.Web.Http.OData.Formatter
{
    internal static class EdmLibHelpers
    {
        ...
        public static IEdmType GetEdmType(this IEdmModel edmModel, Type clrType)
        {
            if (edmModel == null)
            {
                throw new ArgumentNullException("edmModel");//(Error.ArgumentNull("edmModel");
            }

            if (clrType == null)
            {
                throw new ArgumentNullException("clrType"); //Error.ArgumentNull("clrType");
            }
        ...
        public static IEdmTypeReference ToEdmTypeReference(this IEdmType edmType, bool isNullable)
        {
            ...
            switch (edmType.TypeKind)
            {
                ...
                default:
                    throw new NotSupportedException("EdmTypeNotSupported "  + edmType.ToTraceString()); // Error.NotSupported(SRResources.EdmTypeNotSupported, edmType.ToTraceString());
            }
        }
