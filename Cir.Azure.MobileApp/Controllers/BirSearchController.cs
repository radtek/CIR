...
namespace Cir.Azure.MobileApp.Controllers
{
    ...
    public class BirSearchController : ApiController
    {
        ...
        /// <returns></returns>        
        public List<Cir.Azure.MobileApp.CirSyncService.Bir> Post(Cir.Azure.MobileApp.CirSyncService.Bir bir)
        {
            //Cir.Azure.MobileApp.CirSyncService.CirQuickSearch SearchItems = new CirSyncService.CirQuickSearch();
        ...
        public Cir.Azure.MobileApp.CirSyncService.BirFile BirWordFile(long Id)
        {
            this.Configuration.Services.GetTraceWriter().Info("Entered Bir sesarch custom controller!");
            try
            {
                Cir.Azure.MobileApp.CirSyncService.BirFile oFileInfo = new CirSyncService.BirFile();

                Cir.Azure.MobileApp.CirSyncService.Bir oBir = (new SyncServiceUtilities(this)).BirFile(
                    BirID: Id
                    );
                if (oBir.File != null)
                {
                    ...
                    oFileInfo.FileName = oBir.File.FileName.Replace(@"\", "_").Replace("/", "_") + ".docx";
                }
        ...
        public Cir.Azure.MobileApp.CirSyncService.BirFile BirPdfFile(long Id)
        {
            this.Configuration.Services.GetTraceWriter().Info("Entered Bir sesarch custom controller!");
            try
            {
                ...
                Cir.Azure.MobileApp.CirSyncService.Bir oBir = (new SyncServiceUtilities(this)).GetBirPDF(
                    BirDataID: Id
                    );
        ...
        public Cir.Azure.MobileApp.CirSyncService.BirFile CirPdfFile(long Id, long cirid = 0)
        {
            this.Configuration.Services.GetTraceWriter().Info("Entered Bir sesarch custom controller!");
            try
            {
                ...
                Cir.Azure.MobileApp.CirSyncService.Bir oBir = (new SyncServiceUtilities(this)).GetCirPDF(
        ...
        public Cir.Azure.MobileApp.CirSyncService.BirFile CirPdfFileByCIRId(long Id)
        {
            this.Configuration.Services.GetTraceWriter().Info("Entered Bir sesarch custom controller!");
        ...
        public Cir.Azure.MobileApp.CirSyncService.BirFile CirPdfFileZip(string Id)
        {
            this.Configuration.Services.GetTraceWriter().Info("Entered Bir sesarch custom controller!");
            try
            {
                ...
                Cir.Azure.MobileApp.CirSyncService.Bir oBir = (new SyncServiceUtilities(this)).GetCIRPdfZip(
                    CirDataIDs: Id
                    );
                if (oBir.File != null)
                {
