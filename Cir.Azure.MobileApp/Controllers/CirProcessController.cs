...
namespace Cir.Azure.MobileApp.Controllers
{
    ...
    public class CirProcessController : ApiController
    {
        ...
        public Cir.Azure.MobileApp.CirSyncService.CirDataActionResponse Post(Cir.Azure.MobileApp.CirSyncService.CirDataDetail cirDataDetail)
        {
            ...
            try
            {
                ...
                Cir.Azure.MobileApp.CirSyncService.CirDataActionResponse cirDataActionResponse = new Cir.Azure.MobileApp.CirSyncService.CirDataActionResponse();
                if (userInfo != null)
                {
                    ...
                    if (cirDataDetail.Progress == 8)
                    {
                         ...
                         if (hasaccess == true)
                        {
                           // Cir.Azure.MobileApp.CirSyncService.CirDataDetail existingCirData = (new SyncServiceUtilities(this)).GetCirDataDetailForView((cirDataDetail.CirDataId));
        ...
        public Cir.Azure.MobileApp.CirSyncService.CirDataDetail GetCirDataDetail(long CirDataId)
        {
