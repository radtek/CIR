...
namespace Cir.Azure.MobileApp.Controllers
{
    ...
    {
        public List<Cir.Azure.MobileApp.CirSyncService.CirRevision> POST(Cir.Azure.MobileApp.CirSyncService.CirRevision cirRevision)
        {

            List<Cir.Azure.MobileApp.CirSyncService.CirRevision> oResponse;
