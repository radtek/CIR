...
namespace Cir.Azure.MobileApp.Controllers
{
    ...
    public class CirAdvancedSearchController : ApiController
    {
        ...
        public Cir.Azure.MobileApp.CirSyncService.AdvanceSearchModel PostSearch(Cir.Azure.MobileApp.CirSyncService.AdvanceSearchModel Model)
        {
            try
            {
        ...
        public Cir.Azure.MobileApp.CirSyncService.AdvanceSearchModel GetLoadProfile(long ProfileId)
        {
            try
            {
                this.Configuration.Services.GetTraceWriter().Info("Entered AdvancedSearch custom controller!");
        ...
        public Cir.Azure.MobileApp.CirSyncService.AdvanceSearchModel PostSaveProfile(Cir.Azure.MobileApp.CirSyncService.AdvanceSearchModel Model)
        {
            try
            {
        ...
        [HttpDelete]
        public Cir.Azure.MobileApp.CirSyncService.AdvanceSearchModel Delete(long ProfileId)
        {
            try
            {
