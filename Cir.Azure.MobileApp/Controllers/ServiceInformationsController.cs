...
namespace Cir.Azure.MobileApp.Controllers
{
    ...
    public class ServiceInformationsController : ApiController
    {
        ...
        public List<Cir.Azure.MobileApp.CirSyncService.ServiceInformations> GetAll()
        {
        ...
        public List<Cir.Azure.MobileApp.CirSyncService.ServiceInformations> GetMyServiceInformation()
        {
            this.Configuration.Services.GetTraceWriter().Info("Entered  custom controller! -Post");
            try
            {
        ...
        /// <CreatedBy>Mukul Keshari</CreatedBy>
         [AuthorizeAadRole(Roles = "Administrator")]
        public Cir.Azure.MobileApp.CirSyncService.ServiceInformations Get(long Id)
        {
        ...
        /// <CreatedBy>Mukul Keshari</CreatedBy>
         [AuthorizeAadRole(Roles = "Administrator")]
        public Cir.Azure.MobileApp.CirSyncService.ServiceInformations Put(Cir.Azure.MobileApp.CirSyncService.ServiceInformations oServiceInformations)
        {
            this.Configuration.Services.GetTraceWriter().Info("Entered ServiceInformations custom controller! -PUT");
            try
            {
        ...
        public bool Delete(long Id)
        {
            ...
            try
            {
                Cir.Azure.MobileApp.CirSyncService.ServiceInformations oServiceInformations = new CirSyncService.ServiceInformations();
