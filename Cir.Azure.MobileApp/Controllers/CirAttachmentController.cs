...
namespace Cir.Azure.MobileApp.Controllers
{
    ...
    public class CirAttachmentController : ApiController
    {
        ...
        public Cir.Azure.MobileApp.CirSyncService.CirAttachments Get(Int64 Id)
        {
        ...
        public List<Cir.Azure.MobileApp.CirSyncService.CirAttachments> GetAttachments(long Id)
        {
        ...
        [HttpPost]
        public bool Post(Cir.Azure.MobileApp.CirSyncService.CirAttachments attachment)
        {
