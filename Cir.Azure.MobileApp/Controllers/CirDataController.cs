...
namespace Cir.Azure.MobileApp.Controllers
{
    ...
    public class CirDataController : ApiController
    {
        ...
        /// </summary>
        /// <param name="Id"></param>
        /// <returns>Cir.Azure.MobileApp.CirSyncService.ComponentInspectionReport from Cir Sync Wcf Service</returns>
        /// <CreatedBy>Mukul Keshari</CreatedBy>
        public Cir.Azure.MobileApp.CirSyncService.ComponentInspectionReport Get(Int64 Id)
        {
        ...
        /// <CreatedBy>Mukul Keshari</CreatedBy>
        public Cir.Azure.MobileApp.CirSyncService.CirResponse Post(Cir.Azure.MobileApp.CirSyncService.ComponentInspectionReport Cir)
        {
            Cir.Azure.MobileApp.CirSyncService.CirResponse oResponse;
