...
InnovaHxReg /U /P /productnamespace:MS.VSIPCC.v80 /producthxt:_DEFAULT /namespace:SD.LLBLGen.Pro.25.ReferenceManual.NET20 /hxt:_DEFAULT

REM Un-Register the help file (title in Help 2.0 terminology)
InnovaHxReg /U /T /namespace:SD.LLBLGen.Pro.25.ReferenceManual.NET20 /id:LLBLGenPro25.NET20 /langid:1033 /helpfile:LLBLGen.Pro.v25.Reference.Manual.NET2x.hxs

REM Un-Register the Namespace
InnovaHxReg /U /N /Namespace:SD.LLBLGen.Pro.25.ReferenceManual.NET20 /Description:"LLBLGen Pro v2.5 .NET 2.0 Reference Manual" /Collection:COL_LLBLGen.Pro.v2.Reference.Manual.NET2x.hxc
