                ...
                <div class="well well-White">
                    <div class="bs-example form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <%: Html.Label("Assigned Roles", new { @class="col-lg-3 control-label" })%>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group">
                                <div class="col-lg-9 col-lg-offset-3">
                                     <button id="btnUnAssign" type="button" class="btn btn-primary">Un Assign</button>
                                    <a href="cir/unassign-user" class="btn btn-default">Cancel</a>
                                </div>
                            </div>
                        </fieldset>
                    </div>
