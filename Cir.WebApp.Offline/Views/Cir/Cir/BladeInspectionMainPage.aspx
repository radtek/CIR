...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        function RunInspectTool() {
            console.log("RunInspect");
            if (isElectronApp) {
                console.log("RunInspect2");
    ...
    <section class="content" style="background: transparent">
        ...
        <button type="button" class="btn btn-primary" id="drone-inspection-btn" onclick="RunInspectTool()">Drone Inspection</button>
