...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'TurbineTemperatureVariant'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class TurbineTemperatureVariantEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<TurbineManufacturerEntity> _turbineManufacturerCollectionViaTurbineMatrix;
		...
		public static class MemberNames
		{
			...
			public static readonly string TurbineManufacturerCollectionViaTurbineMatrix = "TurbineManufacturerCollectionViaTurbineMatrix";
		...
		static TurbineTemperatureVariantEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public TurbineTemperatureVariantEntity():base("TurbineTemperatureVariantEntity")
		{
		...
		public TurbineTemperatureVariantEntity(IEntityFields2 fields):base("TurbineTemperatureVariantEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this TurbineTemperatureVariantEntity</param>
		public TurbineTemperatureVariantEntity(IValidator validator):base("TurbineTemperatureVariantEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="turbineTemperatureVariantId">PK value for TurbineTemperatureVariant which data should be fetched into this TurbineTemperatureVariant object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TurbineTemperatureVariantEntity(System.Int64 turbineTemperatureVariantId):base("TurbineTemperatureVariantEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.TurbineTemperatureVariantId = turbineTemperatureVariantId;
		}
		...
		/// <param name="validator">The custom validator object for this TurbineTemperatureVariantEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TurbineTemperatureVariantEntity(System.Int64 turbineTemperatureVariantId, IValidator validator):base("TurbineTemperatureVariantEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.TurbineTemperatureVariantId = turbineTemperatureVariantId;
		}
		...
		protected TurbineTemperatureVariantEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_turbineManufacturerCollectionViaTurbineMatrix = (EntityCollection<TurbineManufacturerEntity>)info.GetValue("_turbineManufacturerCollectionViaTurbineMatrix", typeof(EntityCollection<TurbineManufacturerEntity>));
		...
		{
			switch((TurbineTemperatureVariantFieldIndex)fieldIndex)
			{
				default:
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				...
				case "TurbineManufacturerCollectionViaTurbineMatrix":
					this.TurbineManufacturerCollectionViaTurbineMatrix.IsReadOnly = false;
					this.TurbineManufacturerCollectionViaTurbineMatrix.Add((TurbineManufacturerEntity)entity);
					this.TurbineManufacturerCollectionViaTurbineMatrix.IsReadOnly = true;
					break;
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_turbineManufacturerCollectionViaTurbineMatrix", ((_turbineManufacturerCollectionViaTurbineMatrix!=null) && (_turbineManufacturerCollectionViaTurbineMatrix.Count>0) && !this.MarkedForDeletion)?_turbineManufacturerCollectionViaTurbineMatrix:null);
		...
		public bool TestOriginalFieldValueForNull(TurbineTemperatureVariantFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(TurbineTemperatureVariantFieldIndex fieldIndex)
		{
		...
		{
			return new TurbineTemperatureVariantRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoTurbineMatrix()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TurbineMatrixFields.TurbineTemperatureVariantId, null, ComparisonOperator.Equal, this.TurbineTemperatureVariantId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(TurbineTemperatureVariantEntity.Relations.TurbineMatrixEntityUsingTurbineTemperatureVariantId, "TurbineTemperatureVariantEntity__", "TurbineMatrix_", JoinHint.None);
			bucket.Relations.Add(TurbineMatrixEntity.Relations.TurbineEntityUsingTurbineId, "TurbineMatrix_", string.Empty, JoinHint.None);
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TurbineTemperatureVariantFields.TurbineTemperatureVariantId, null, ComparisonOperator.Equal, this.TurbineTemperatureVariantId, "TurbineTemperatureVariantEntity__"));
			return bucket;
		}
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch
		/// the related entities of type 'TurbineManufacturer' to this entity. Use DataAccessAdapter.FetchEntityCollection() to fetch these related entities.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoTurbineManufacturerCollectionViaTurbineMatrix()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(TurbineTemperatureVariantEntity.Relations.TurbineMatrixEntityUsingTurbineTemperatureVariantId, "TurbineTemperatureVariantEntity__", "TurbineMatrix_", JoinHint.None);
			bucket.Relations.Add(TurbineMatrixEntity.Relations.TurbineManufacturerEntityUsingTurbineManufacturerId, "TurbineMatrix_", string.Empty, JoinHint.None);
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TurbineTemperatureVariantFields.TurbineTemperatureVariantId, null, ComparisonOperator.Equal, this.TurbineTemperatureVariantId, "TurbineTemperatureVariantEntity__"));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(TurbineTemperatureVariantEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._turbineManufacturerCollectionViaTurbineMatrix);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._turbineManufacturerCollectionViaTurbineMatrix = (EntityCollection<TurbineManufacturerEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			if (this._turbineManufacturerCollectionViaTurbineMatrix != null)
			{
				return true;
			}
		...
		protected override void CreateMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue, Queue<bool> requiredQueue) 
		{
			...
			collectionsQueue.Enqueue(requiredQueue.Dequeue() ? new EntityCollection<TurbineManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineManufacturerEntityFactory))) : null);
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_turbineManufacturerCollectionViaTurbineMatrix!=null)
			{
				_turbineManufacturerCollectionViaTurbineMatrix.ActiveContext = base.ActiveContext;
			}
		...
		protected virtual void InitClassMembers()
		{
			...
			_turbineManufacturerCollectionViaTurbineMatrix = null;
		...
		/// <param name="validator">The validator object for this TurbineTemperatureVariantEntity</param>
		...
		public  static TurbineTemperatureVariantRelations Relations
		{
			get	{ return new TurbineTemperatureVariantRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineMatrix
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<TurbineMatrixEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineMatrixEntityFactory))),
					TurbineTemperatureVariantEntity.Relations.TurbineMatrixEntityUsingTurbineTemperatureVariantId, 
					(int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineMatrixEntity, 0, null, null, null, null, "TurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineCollectionViaTurbineMatrix
		{
			get
			{
				...
				IEntityRelation intermediateRelation = TurbineTemperatureVariantEntity.Relations.TurbineMatrixEntityUsingTurbineTemperatureVariantId;
				intermediateRelation.SetAliases(string.Empty, "TurbineMatrix_");
				relations.Add(TurbineTemperatureVariantEntity.Relations.TurbineMatrixEntityUsingTurbineTemperatureVariantId, "TurbineTemperatureVariantEntity__", "TurbineMatrix_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineEntity, 0, null, null, relations, null, "TurbineCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineFrequencyCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineFrequencyEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineFrequencyEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, 0, null, null, relations, null, "TurbineFrequencyCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// for this entity. Add the object returned by this property to an existing PrefetchPath2 instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathTurbineManufacturerCollectionViaTurbineMatrix
		{
			get
			{
				IRelationCollection relations = new RelationCollection();
				...
				intermediateRelation.SetAliases(string.Empty, "TurbineMatrix_");
				relations.Add(TurbineTemperatureVariantEntity.Relations.TurbineMatrixEntityUsingTurbineTemperatureVariantId, "TurbineTemperatureVariantEntity__", "TurbineMatrix_", JoinHint.None);
				relations.Add(TurbineMatrixEntity.Relations.TurbineManufacturerEntityUsingTurbineManufacturerId, "TurbineMatrix_", string.Empty, JoinHint.None);
				return new PrefetchPathElement2(new EntityCollection<TurbineManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineManufacturerEntity, 0, null, null, relations, null, "TurbineManufacturerCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineMarkVersionCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineMarkVersionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineMarkVersionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineMarkVersionEntity, 0, null, null, relations, null, "TurbineMarkVersionCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineNominelPowerCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineNominelPowerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineNominelPowerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineNominelPowerEntity, 0, null, null, relations, null, "TurbineNominelPowerCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineOldCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineOldEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineOldEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, 0, null, null, relations, null, "TurbineOldCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbinePlacementCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbinePlacementEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbinePlacementEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, (int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, 0, null, null, relations, null, "TurbinePlacementCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbinePowerRegulationCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbinePowerRegulationEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbinePowerRegulationEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, (int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, 0, null, null, relations, null, "TurbinePowerRegulationCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineRotorDiameterCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineRotorDiameterEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineRotorDiameterEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, 0, null, null, relations, null, "TurbineRotorDiameterCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineSmallGeneratorCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineSmallGeneratorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineSmallGeneratorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, 0, null, null, relations, null, "TurbineSmallGeneratorCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineVoltageCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineVoltageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineVoltageEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineVoltageEntity, 0, null, null, relations, null, "TurbineVoltageCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return TurbineTemperatureVariantEntity.CustomProperties;}
		}
		...
		{
			get { return TurbineTemperatureVariantEntity.FieldsCustomProperties;}
		}

		/// <summary> The TurbineTemperatureVariantId property of the Entity TurbineTemperatureVariant<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineTemperatureVariant"."TurbineTemperatureVariantId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 TurbineTemperatureVariantId
		{
			get { return (System.Int64)GetValue((int)TurbineTemperatureVariantFieldIndex.TurbineTemperatureVariantId, true); }
			set	{ SetValue((int)TurbineTemperatureVariantFieldIndex.TurbineTemperatureVariantId, value); }
		}

		/// <summary> The TemperatureVariant property of the Entity TurbineTemperatureVariant<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineTemperatureVariant"."TemperatureVariant"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 20<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String TemperatureVariant
		{
			get { return (System.String)GetValue((int)TurbineTemperatureVariantFieldIndex.TemperatureVariant, true); }
			set	{ SetValue((int)TurbineTemperatureVariantFieldIndex.TemperatureVariant, value); }
		}

		/// <summary> The Created property of the Entity TurbineTemperatureVariant<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineTemperatureVariant"."Created"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime Created
		{
			get { return (System.DateTime)GetValue((int)TurbineTemperatureVariantFieldIndex.Created, true); }
			set	{ SetValue((int)TurbineTemperatureVariantFieldIndex.Created, value); }
		}

		/// <summary> The CreatedBy property of the Entity TurbineTemperatureVariant<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineTemperatureVariant"."CreatedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String CreatedBy
		{
			get { return (System.String)GetValue((int)TurbineTemperatureVariantFieldIndex.CreatedBy, true); }
			set	{ SetValue((int)TurbineTemperatureVariantFieldIndex.CreatedBy, value); }
		}

		/// <summary> The Deleted property of the Entity TurbineTemperatureVariant<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineTemperatureVariant"."Deleted"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> Deleted
		{
			get { return (Nullable<System.DateTime>)GetValue((int)TurbineTemperatureVariantFieldIndex.Deleted, false); }
			set	{ SetValue((int)TurbineTemperatureVariantFieldIndex.Deleted, value); }
		}

		/// <summary> The DeletedBy property of the Entity TurbineTemperatureVariant<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineTemperatureVariant"."DeletedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String DeletedBy
		{
			get { return (System.String)GetValue((int)TurbineTemperatureVariantFieldIndex.DeletedBy, true); }
			set	{ SetValue((int)TurbineTemperatureVariantFieldIndex.DeletedBy, value); }
		}
		...
		public virtual EntityCollection<TurbineMatrixEntity> TurbineMatrix
		{
			get
			{
				if(_turbineMatrix==null)
				{
					...
					_turbineMatrix.SetContainingEntityInfo(this, "TurbineTemperatureVariant");
				}
		...
		/// <summary> Gets the EntityCollection with the related entities of type 'TurbineManufacturerEntity' which are related to this entity via a relation of type 'm:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(TurbineManufacturerEntity))]
		public virtual EntityCollection<TurbineManufacturerEntity> TurbineManufacturerCollectionViaTurbineMatrix
		{
			get
			{
				if(_turbineManufacturerCollectionViaTurbineMatrix==null)
				{
					_turbineManufacturerCollectionViaTurbineMatrix = new EntityCollection<TurbineManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineManufacturerEntityFactory)));
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity; }
		}
		#endregion
