...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'TurbineFrequency'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class TurbineFrequencyEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static TurbineFrequencyEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public TurbineFrequencyEntity():base("TurbineFrequencyEntity")
		{
		...
		public TurbineFrequencyEntity(IEntityFields2 fields):base("TurbineFrequencyEntity")
		{
		...
		public TurbineFrequencyEntity(IValidator validator):base("TurbineFrequencyEntity")
		{
		...
		public TurbineFrequencyEntity(System.Int64 turbineFrequencyId):base("TurbineFrequencyEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.TurbineFrequencyId = turbineFrequencyId;
		}
		...
		/// <param name="validator">The custom validator object for this TurbineFrequencyEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TurbineFrequencyEntity(System.Int64 turbineFrequencyId, IValidator validator):base("TurbineFrequencyEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.TurbineFrequencyId = turbineFrequencyId;
		}
		...
		protected TurbineFrequencyEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((TurbineFrequencyFieldIndex)fieldIndex)
			{
				default:
		...
		public bool TestOriginalFieldValueForNull(TurbineFrequencyFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(TurbineFrequencyFieldIndex fieldIndex)
		{
		...
		public virtual IRelationPredicateBucket GetRelationInfoTurbineMatrix()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TurbineMatrixFields.TurbineFrequencyId, null, ComparisonOperator.Equal, this.TurbineFrequencyId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(TurbineFrequencyEntity.Relations.TurbineMatrixEntityUsingTurbineFrequencyId, "TurbineFrequencyEntity__", "TurbineMatrix_", JoinHint.None);
			bucket.Relations.Add(TurbineMatrixEntity.Relations.TurbineEntityUsingTurbineId, "TurbineMatrix_", string.Empty, JoinHint.None);
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TurbineFrequencyFields.TurbineFrequencyId, null, ComparisonOperator.Equal, this.TurbineFrequencyId, "TurbineFrequencyEntity__"));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(TurbineFrequencyEntityFactory));
		}
#if !CF
		...
		public  static TurbineFrequencyRelations Relations
		{
			get	{ return new TurbineFrequencyRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineMatrix
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<TurbineMatrixEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineMatrixEntityFactory))),
					TurbineFrequencyEntity.Relations.TurbineMatrixEntityUsingTurbineFrequencyId, 
					(int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineMatrixEntity, 0, null, null, null, null, "TurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineCollectionViaTurbineMatrix
		{
			get
			{
				...
				IEntityRelation intermediateRelation = TurbineFrequencyEntity.Relations.TurbineMatrixEntityUsingTurbineFrequencyId;
				intermediateRelation.SetAliases(string.Empty, "TurbineMatrix_");
				relations.Add(TurbineFrequencyEntity.Relations.TurbineMatrixEntityUsingTurbineFrequencyId, "TurbineFrequencyEntity__", "TurbineMatrix_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineEntity, 0, null, null, relations, null, "TurbineCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineManufacturerCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineManufacturerEntity, 0, null, null, relations, null, "TurbineManufacturerCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineMarkVersionCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineMarkVersionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineMarkVersionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineMarkVersionEntity, 0, null, null, relations, null, "TurbineMarkVersionCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineNominelPowerCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineNominelPowerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineNominelPowerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineNominelPowerEntity, 0, null, null, relations, null, "TurbineNominelPowerCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineOldCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineOldEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineOldEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, 0, null, null, relations, null, "TurbineOldCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbinePlacementCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbinePlacementEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbinePlacementEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, (int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, 0, null, null, relations, null, "TurbinePlacementCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbinePowerRegulationCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbinePowerRegulationEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbinePowerRegulationEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, (int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, 0, null, null, relations, null, "TurbinePowerRegulationCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineRotorDiameterCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineRotorDiameterEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineRotorDiameterEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, 0, null, null, relations, null, "TurbineRotorDiameterCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineSmallGeneratorCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineSmallGeneratorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineSmallGeneratorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, 0, null, null, relations, null, "TurbineSmallGeneratorCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineTemperatureVariantCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineTemperatureVariantEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineTemperatureVariantEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, 0, null, null, relations, null, "TurbineTemperatureVariantCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineVoltageCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineVoltageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineVoltageEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineVoltageEntity, 0, null, null, relations, null, "TurbineVoltageCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return TurbineFrequencyEntity.CustomProperties;}
		}
		...
		{
			get { return TurbineFrequencyEntity.FieldsCustomProperties;}
		}

		/// <summary> The TurbineFrequencyId property of the Entity TurbineFrequency<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineFrequency"."TurbineFrequencyId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 TurbineFrequencyId
		{
			get { return (System.Int64)GetValue((int)TurbineFrequencyFieldIndex.TurbineFrequencyId, true); }
			set	{ SetValue((int)TurbineFrequencyFieldIndex.TurbineFrequencyId, value); }
		}

		/// <summary> The Frequency property of the Entity TurbineFrequency<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineFrequency"."Frequency"<br/>
		/// Table field type characteristics (type, precision, scale, length): TinyInt, 3, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Byte Frequency
		{
			get { return (System.Byte)GetValue((int)TurbineFrequencyFieldIndex.Frequency, true); }
			set	{ SetValue((int)TurbineFrequencyFieldIndex.Frequency, value); }
		}

		/// <summary> The Created property of the Entity TurbineFrequency<br/><br/>
		/// </summary>
		...
		{
			get { return (System.DateTime)GetValue((int)TurbineFrequencyFieldIndex.Created, true); }
			set	{ SetValue((int)TurbineFrequencyFieldIndex.Created, value); }
		}

		/// <summary> The CreatedBy property of the Entity TurbineFrequency<br/><br/>
		/// </summary>
		...
		{
			get { return (System.String)GetValue((int)TurbineFrequencyFieldIndex.CreatedBy, true); }
			set	{ SetValue((int)TurbineFrequencyFieldIndex.CreatedBy, value); }
		}

		/// <summary> The Deleted property of the Entity TurbineFrequency<br/><br/>
		/// </summary>
		...
		{
			get { return (Nullable<System.DateTime>)GetValue((int)TurbineFrequencyFieldIndex.Deleted, false); }
			set	{ SetValue((int)TurbineFrequencyFieldIndex.Deleted, value); }
		}

		/// <summary> The DeletedBy property of the Entity TurbineFrequency<br/><br/>
		/// </summary>
		...
		{
			get { return (System.String)GetValue((int)TurbineFrequencyFieldIndex.DeletedBy, true); }
			set	{ SetValue((int)TurbineFrequencyFieldIndex.DeletedBy, value); }
		}
		...
		public virtual EntityCollection<TurbineMatrixEntity> TurbineMatrix
		{
			get
			{
				if(_turbineMatrix==null)
				{
					...
					_turbineMatrix.SetContainingEntityInfo(this, "TurbineFrequency");
				}
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity; }
		}
		#endregion
