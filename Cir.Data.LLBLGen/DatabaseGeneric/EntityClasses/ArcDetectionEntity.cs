...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ArcDetection'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ArcDetectionEntity : CommonEntityBase, ISerializable
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfaces
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private EntityCollection<ArcDetectionEntity> _arcDetection_;
		...
		public static class MemberNames
		{
			...
			/// <summary>Member name ArcDetection_</summary>
			public static readonly string ArcDetection_ = "ArcDetection_";
		...
		static ArcDetectionEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public ArcDetectionEntity():base("ArcDetectionEntity")
		{
		...
		public ArcDetectionEntity(IEntityFields2 fields):base("ArcDetectionEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ArcDetectionEntity</param>
		public ArcDetectionEntity(IValidator validator):base("ArcDetectionEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="arcDetectionId">PK value for ArcDetection which data should be fetched into this ArcDetection object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ArcDetectionEntity(System.Int64 arcDetectionId):base("ArcDetectionEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.ArcDetectionId = arcDetectionId;
		}
		...
		/// <param name="validator">The custom validator object for this ArcDetectionEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ArcDetectionEntity(System.Int64 arcDetectionId, IValidator validator):base("ArcDetectionEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.ArcDetectionId = arcDetectionId;
		}
		...
		protected ArcDetectionEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				_arcDetection_ = (EntityCollection<ArcDetectionEntity>)info.GetValue("_arcDetection_", typeof(EntityCollection<ArcDetectionEntity>));
		...
		{
			switch((ArcDetectionFieldIndex)fieldIndex)
			{
				case ArcDetectionFieldIndex.ParentArcDetectionId:
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				case "ArcDetection":
					...
					break;
				case "ArcDetection_":
					this.ArcDetection_.Add((ArcDetectionEntity)entity);
					break;
		...
		public override void SetRelatedEntity(IEntity2 relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				case "ArcDetection":
					...
					break;
				case "ArcDetection_":
					this.ArcDetection_.Add((ArcDetectionEntity)relatedEntity);
					OnRelatedEntitySet(relatedEntity, fieldName);
					break;
				case "ComponentInspectionReportTransformer":
		...
		public override void UnsetRelatedEntity(IEntity2 relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				case "ArcDetection":
					...
					break;
				case "ArcDetection_":
					base.PerformRelatedEntityRemoval(this.ArcDetection_, relatedEntity, signalRelatedEntityManyToOne);
					OnRelatedEntityUnset(relatedEntity, fieldName);
					break;
				case "ComponentInspectionReportTransformer":
		...
		public override List<IEntityCollection2> GetMemberEntityCollections()
		{
			...
			toReturn.Add(this.ArcDetection_);
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_arcDetection_", ((_arcDetection_!=null) && (_arcDetection_.Count>0) && !this.MarkedForDeletion)?_arcDetection_:null);
		...
		public bool TestOriginalFieldValueForNull(ArcDetectionFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ArcDetectionFieldIndex fieldIndex)
		{
		...
		{
			return new ArcDetectionRelations().GetAllRelations();
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoArcDetection_()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ArcDetectionFields.ParentArcDetectionId, null, ComparisonOperator.Equal, this.ArcDetectionId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentInspectionReportTransformerFields.TransformerArcDetectionId, null, ComparisonOperator.Equal, this.ArcDetectionId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(ArcDetectionEntity.Relations.ComponentInspectionReportTransformerEntityUsingTransformerArcDetectionId, "ArcDetectionEntity__", "ComponentInspectionReportTransformer_", JoinHint.None);
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ArcDetectionFields.ArcDetectionId, null, ComparisonOperator.Equal, this.ArcDetectionId, "ArcDetectionEntity__"));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ArcDetectionFields.ArcDetectionId, null, ComparisonOperator.Equal, this.ParentArcDetectionId));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.ArcDetectionEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ArcDetectionEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._arcDetection_);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._arcDetection_ = (EntityCollection<ArcDetectionEntity>) collectionsQueue.Dequeue();
		...
		public override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("ArcDetection_", _arcDetection_);
		...
		{
			if(_arcDetection_!=null)
			{
				_arcDetection_.ActiveContext = base.ActiveContext;
			}
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ArcDetectionId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			...
			_fieldsCustomProperties.Add("ParentArcDetectionId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			base.PerformDesetupSyncRelatedEntity( _arcDetection, new PropertyChangedEventHandler( OnArcDetectionPropertyChanged ), "ArcDetection", ArcDetectionEntity.Relations.ArcDetectionEntityUsingArcDetectionIdParentArcDetectionId, true, signalRelatedEntity, "ArcDetection_", resetFKFields, new int[] { (int)ArcDetectionFieldIndex.ParentArcDetectionId } );		
			_arcDetection = null;
		}
		...
		private void SetupSyncArcDetection(IEntity2 relatedEntity)
		{
			...
			base.PerformSetupSyncRelatedEntity( _arcDetection, new PropertyChangedEventHandler( OnArcDetectionPropertyChanged ), "ArcDetection", ArcDetectionEntity.Relations.ArcDetectionEntityUsingArcDetectionIdParentArcDetectionId, true, new string[] {  } );
		}
		...
		/// <param name="validator">The validator object for this ArcDetectionEntity</param>
		...
		public  static ArcDetectionRelations Relations
		{
			get	{ return new ArcDetectionRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathArcDetection_
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ArcDetectionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ArcDetectionEntityFactory))),
					ArcDetectionEntity.Relations.ArcDetectionEntityUsingParentArcDetectionId, 
					(int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, (int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, 0, null, null, null, null, "ArcDetection_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportTransformer
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ComponentInspectionReportTransformerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportTransformerEntityFactory))),
					ArcDetectionEntity.Relations.ComponentInspectionReportTransformerEntityUsingTransformerArcDetectionId, 
					(int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTransformerEntity, 0, null, null, null, null, "ComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathActionOnTransformerCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				IEntityRelation intermediateRelation = ArcDetectionEntity.Relations.ComponentInspectionReportTransformerEntityUsingTransformerArcDetectionId;
				intermediateRelation.SetAliases(string.Empty, "ComponentInspectionReportTransformer_");
				relations.Add(ArcDetectionEntity.Relations.ComponentInspectionReportTransformerEntityUsingTransformerArcDetectionId, "ArcDetectionEntity__", "ComponentInspectionReportTransformer_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<ActionOnTransformerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ActionOnTransformerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, (int)Cir.Data.LLBLGen.EntityType.ActionOnTransformerEntity, 0, null, null, relations, null, "ActionOnTransformerCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBooleanAnswerCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BooleanAnswerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BooleanAnswerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, (int)Cir.Data.LLBLGen.EntityType.BooleanAnswerEntity, 0, null, null, relations, null, "BooleanAnswerCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBracketsCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BracketsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BracketsEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, (int)Cir.Data.LLBLGen.EntityType.BracketsEntity, 0, null, null, relations, null, "BracketsCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCableConditionCollectionViaComponentInspectionReportTransformer_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CableConditionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CableConditionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, (int)Cir.Data.LLBLGen.EntityType.CableConditionEntity, 0, null, null, relations, null, "CableConditionCollectionViaComponentInspectionReportTransformer_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCableConditionCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CableConditionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CableConditionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, (int)Cir.Data.LLBLGen.EntityType.CableConditionEntity, 0, null, null, relations, null, "CableConditionCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathClimateCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ClimateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ClimateEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, (int)Cir.Data.LLBLGen.EntityType.ClimateEntity, 0, null, null, relations, null, "ClimateCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCoilConditionCollectionViaComponentInspectionReportTransformer_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CoilConditionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CoilConditionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, (int)Cir.Data.LLBLGen.EntityType.CoilConditionEntity, 0, null, null, relations, null, "CoilConditionCollectionViaComponentInspectionReportTransformer_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCoilConditionCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CoilConditionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CoilConditionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, (int)Cir.Data.LLBLGen.EntityType.CoilConditionEntity, 0, null, null, relations, null, "CoilConditionCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ComponentInspectionReportEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportEntity, 0, null, null, relations, null, "ComponentInspectionReportCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathConnectionBarsCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ConnectionBarsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ConnectionBarsEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, (int)Cir.Data.LLBLGen.EntityType.ConnectionBarsEntity, 0, null, null, relations, null, "ConnectionBarsCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathSurgeArrestorCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<SurgeArrestorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SurgeArrestorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, (int)Cir.Data.LLBLGen.EntityType.SurgeArrestorEntity, 0, null, null, relations, null, "SurgeArrestorCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTransformerManufacturerCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TransformerManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TransformerManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, (int)Cir.Data.LLBLGen.EntityType.TransformerManufacturerEntity, 0, null, null, relations, null, "TransformerManufacturerCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathArcDetection
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ArcDetectionEntityFactory))),
					ArcDetectionEntity.Relations.ArcDetectionEntityUsingArcDetectionIdParentArcDetectionId, 
					(int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, (int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, 0, null, null, null, null, "ArcDetection", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return ArcDetectionEntity.CustomProperties;}
		}
		...
		{
			get { return ArcDetectionEntity.FieldsCustomProperties;}
		}

		/// <summary> The ArcDetectionId property of the Entity ArcDetection<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ArcDetection"."ArcDetectionId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 ArcDetectionId
		{
			get { return (System.Int64)GetValue((int)ArcDetectionFieldIndex.ArcDetectionId, true); }
			set	{ SetValue((int)ArcDetectionFieldIndex.ArcDetectionId, value); }
		}

		/// <summary> The Name property of the Entity ArcDetection<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ArcDetection"."Name"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)ArcDetectionFieldIndex.Name, true); }
			set	{ SetValue((int)ArcDetectionFieldIndex.Name, value); }
		}

		/// <summary> The LanguageId property of the Entity ArcDetection<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ArcDetection"."LanguageId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 LanguageId
		{
			get { return (System.Int64)GetValue((int)ArcDetectionFieldIndex.LanguageId, true); }
			set	{ SetValue((int)ArcDetectionFieldIndex.LanguageId, value); }
		}

		/// <summary> The ParentArcDetectionId property of the Entity ArcDetection<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ArcDetection"."ParentArcDetectionId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> ParentArcDetectionId
		{
			get { return (Nullable<System.Int64>)GetValue((int)ArcDetectionFieldIndex.ParentArcDetectionId, false); }
			set	{ SetValue((int)ArcDetectionFieldIndex.ParentArcDetectionId, value); }
		}

		/// <summary> The Sort property of the Entity ArcDetection<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ArcDetection"."Sort"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 Sort
		{
			get { return (System.Int64)GetValue((int)ArcDetectionFieldIndex.Sort, true); }
			set	{ SetValue((int)ArcDetectionFieldIndex.Sort, value); }
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'ArcDetectionEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(ArcDetectionEntity))]
		public virtual EntityCollection<ArcDetectionEntity> ArcDetection_
		{
			get
			{
				if(_arcDetection_==null)
				{
					_arcDetection_ = new EntityCollection<ArcDetectionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ArcDetectionEntityFactory)));
					_arcDetection_.SetContainingEntityInfo(this, "ArcDetection");
				}
				return _arcDetection_;
			}
		}
		...
		public virtual EntityCollection<ComponentInspectionReportTransformerEntity> ComponentInspectionReportTransformer
		{
			get
			{
				if(_componentInspectionReportTransformer==null)
				{
					...
					_componentInspectionReportTransformer.SetContainingEntityInfo(this, "ArcDetection");
				}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_arcDetection != null)
						{
							_arcDetection.UnsetRelatedEntity(this, "ArcDetection_");
						}
					}
					else
					{
						((IEntity2)value).SetRelatedEntity(this, "ArcDetection_");
					}
				}
			}
		}
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity; }
		}
		#endregion
