...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ComponentInspectionReportType'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ComponentInspectionReportTypeEntity : CommonEntityBase, ISerializable
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfaces
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private EntityCollection<CirStandardTextsEntity> _cirStandardTexts;
		private EntityCollection<ComponentInspectionReportEntity> _componentInspectionReport;
		private EntityCollection<ComponentInspectionReportTypeEntity> _componentInspectionReportType_;
		private EntityCollection<HotItemEntity> _hotItem;
		...
		public static class MemberNames
		{
			...
			/// <summary>Member name CirStandardTexts</summary>
			public static readonly string CirStandardTexts = "CirStandardTexts";
			...
			/// <summary>Member name ComponentInspectionReportType_</summary>
			public static readonly string ComponentInspectionReportType_ = "ComponentInspectionReportType_";
			/// <summary>Member name HotItem</summary>
			public static readonly string HotItem = "HotItem";
		...
		static ComponentInspectionReportTypeEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public ComponentInspectionReportTypeEntity():base("ComponentInspectionReportTypeEntity")
		{
		...
		public ComponentInspectionReportTypeEntity(IEntityFields2 fields):base("ComponentInspectionReportTypeEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ComponentInspectionReportTypeEntity</param>
		public ComponentInspectionReportTypeEntity(IValidator validator):base("ComponentInspectionReportTypeEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="componentInspectionReportTypeId">PK value for ComponentInspectionReportType which data should be fetched into this ComponentInspectionReportType object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ComponentInspectionReportTypeEntity(System.Int64 componentInspectionReportTypeId):base("ComponentInspectionReportTypeEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.ComponentInspectionReportTypeId = componentInspectionReportTypeId;
		}
		...
		/// <param name="validator">The custom validator object for this ComponentInspectionReportTypeEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ComponentInspectionReportTypeEntity(System.Int64 componentInspectionReportTypeId, IValidator validator):base("ComponentInspectionReportTypeEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.ComponentInspectionReportTypeId = componentInspectionReportTypeId;
		}
		...
		protected ComponentInspectionReportTypeEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				_cirStandardTexts = (EntityCollection<CirStandardTextsEntity>)info.GetValue("_cirStandardTexts", typeof(EntityCollection<CirStandardTextsEntity>));
				...
				_componentInspectionReportType_ = (EntityCollection<ComponentInspectionReportTypeEntity>)info.GetValue("_componentInspectionReportType_", typeof(EntityCollection<ComponentInspectionReportTypeEntity>));
				_hotItem = (EntityCollection<HotItemEntity>)info.GetValue("_hotItem", typeof(EntityCollection<HotItemEntity>));
		...
		{
			switch((ComponentInspectionReportTypeFieldIndex)fieldIndex)
			{
				case ComponentInspectionReportTypeFieldIndex.ParentComponentInspectionReportTypeId:
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				case "ComponentInspectionReportType":
					...
					break;
				case "CirStandardTexts":
					this.CirStandardTexts.Add((CirStandardTextsEntity)entity);
					break;
				case "ComponentInspectionReport":
					this.ComponentInspectionReport.Add((ComponentInspectionReportEntity)entity);
					break;
				case "ComponentInspectionReportType_":
					this.ComponentInspectionReportType_.Add((ComponentInspectionReportTypeEntity)entity);
					break;
				case "HotItem":
					this.HotItem.Add((HotItemEntity)entity);
					break;
		...
		public override void SetRelatedEntity(IEntity2 relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				case "ComponentInspectionReportType":
					...
					break;
				case "CirStandardTexts":
					this.CirStandardTexts.Add((CirStandardTextsEntity)relatedEntity);
					OnRelatedEntitySet(relatedEntity, fieldName);
					break;
				case "ComponentInspectionReport":
					...
					break;
				case "ComponentInspectionReportType_":
					this.ComponentInspectionReportType_.Add((ComponentInspectionReportTypeEntity)relatedEntity);
					OnRelatedEntitySet(relatedEntity, fieldName);
					break;
				case "HotItem":
					this.HotItem.Add((HotItemEntity)relatedEntity);
					OnRelatedEntitySet(relatedEntity, fieldName);
					break;
		...
		public override void UnsetRelatedEntity(IEntity2 relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				case "ComponentInspectionReportType":
					...
					break;
				case "CirStandardTexts":
					base.PerformRelatedEntityRemoval(this.CirStandardTexts, relatedEntity, signalRelatedEntityManyToOne);
					OnRelatedEntityUnset(relatedEntity, fieldName);
					break;
				case "ComponentInspectionReport":
					...
					break;
				case "ComponentInspectionReportType_":
					base.PerformRelatedEntityRemoval(this.ComponentInspectionReportType_, relatedEntity, signalRelatedEntityManyToOne);
					OnRelatedEntityUnset(relatedEntity, fieldName);
					break;
				case "HotItem":
					base.PerformRelatedEntityRemoval(this.HotItem, relatedEntity, signalRelatedEntityManyToOne);
					OnRelatedEntityUnset(relatedEntity, fieldName);
					break;
		...
		public override List<IEntityCollection2> GetMemberEntityCollections()
		{
			...
			toReturn.Add(this.CirStandardTexts);
			toReturn.Add(this.ComponentInspectionReport);
			toReturn.Add(this.ComponentInspectionReportType_);
			toReturn.Add(this.HotItem);
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_cirStandardTexts", ((_cirStandardTexts!=null) && (_cirStandardTexts.Count>0) && !this.MarkedForDeletion)?_cirStandardTexts:null);
				...
				info.AddValue("_componentInspectionReportType_", ((_componentInspectionReportType_!=null) && (_componentInspectionReportType_.Count>0) && !this.MarkedForDeletion)?_componentInspectionReportType_:null);
				info.AddValue("_hotItem", ((_hotItem!=null) && (_hotItem.Count>0) && !this.MarkedForDeletion)?_hotItem:null);
		...
		public bool TestOriginalFieldValueForNull(ComponentInspectionReportTypeFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ComponentInspectionReportTypeFieldIndex fieldIndex)
		{
		...
		{
			return new ComponentInspectionReportTypeRelations().GetAllRelations();
		}
		

		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch
		/// the related entities of type 'CirStandardTexts' to this entity. Use DataAccessAdapter.FetchEntityCollection() to fetch these related entities.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoCirStandardTexts()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(CirStandardTextsFields.ComponentInspectionReportTypeId, null, ComparisonOperator.Equal, this.ComponentInspectionReportTypeId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentInspectionReportFields.ComponentInspectionReportTypeId, null, ComparisonOperator.Equal, this.ComponentInspectionReportTypeId));
			return bucket;
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoComponentInspectionReportType_()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentInspectionReportTypeFields.ParentComponentInspectionReportTypeId, null, ComparisonOperator.Equal, this.ComponentInspectionReportTypeId));
			return bucket;
		}

		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch
		/// the related entities of type 'HotItem' to this entity. Use DataAccessAdapter.FetchEntityCollection() to fetch these related entities.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoHotItem()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(HotItemFields.ComponentInspectionReportTypeId, null, ComparisonOperator.Equal, this.ComponentInspectionReportTypeId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(ComponentInspectionReportTypeEntity.Relations.ComponentInspectionReportEntityUsingComponentInspectionReportTypeId, "ComponentInspectionReportTypeEntity__", "ComponentInspectionReport_", JoinHint.None);
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentInspectionReportTypeFields.ComponentInspectionReportTypeId, null, ComparisonOperator.Equal, this.ComponentInspectionReportTypeId, "ComponentInspectionReportTypeEntity__"));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentInspectionReportTypeFields.ComponentInspectionReportTypeId, null, ComparisonOperator.Equal, this.ParentComponentInspectionReportTypeId));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportTypeEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._cirStandardTexts);
			collectionsQueue.Enqueue(this._componentInspectionReport);
			collectionsQueue.Enqueue(this._componentInspectionReportType_);
			collectionsQueue.Enqueue(this._hotItem);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._cirStandardTexts = (EntityCollection<CirStandardTextsEntity>) collectionsQueue.Dequeue();
			this._componentInspectionReport = (EntityCollection<ComponentInspectionReportEntity>) collectionsQueue.Dequeue();
			this._componentInspectionReportType_ = (EntityCollection<ComponentInspectionReportTypeEntity>) collectionsQueue.Dequeue();
			this._hotItem = (EntityCollection<HotItemEntity>) collectionsQueue.Dequeue();
		...
		{
			if (this._cirStandardTexts != null)
			{
				return true;
			}
			...
			if (this._componentInspectionReportType_ != null)
			{
				return true;
			}
		...
		protected override void CreateMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue, Queue<bool> requiredQueue) 
		{
			...
			collectionsQueue.Enqueue(requiredQueue.Dequeue() ? new EntityCollection<CirStandardTextsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CirStandardTextsEntityFactory))) : null);
			...
			collectionsQueue.Enqueue(requiredQueue.Dequeue() ? new EntityCollection<HotItemEntity>(EntityFactoryCache2.GetEntityFactory(typeof(HotItemEntityFactory))) : null);
		...
		public override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("CirStandardTexts", _cirStandardTexts);
			toReturn.Add("ComponentInspectionReport", _componentInspectionReport);
			toReturn.Add("ComponentInspectionReportType_", _componentInspectionReportType_);
			toReturn.Add("HotItem", _hotItem);
		...
		{
			if(_cirStandardTexts!=null)
			{
				_cirStandardTexts.ActiveContext = base.ActiveContext;
			}
			if(_componentInspectionReport!=null)
			{
				_componentInspectionReport.ActiveContext = base.ActiveContext;
			}
			if(_componentInspectionReportType_!=null)
			{
				_componentInspectionReportType_.ActiveContext = base.ActiveContext;
			}
			if(_hotItem!=null)
			{
				_hotItem.ActiveContext = base.ActiveContext;
			}
		...
		protected virtual void InitClassMembers()
		{
			...
			_cirStandardTexts = null;
			_componentInspectionReport = null;
			_componentInspectionReportType_ = null;
			_hotItem = null;
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ParentComponentInspectionReportTypeId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			base.PerformDesetupSyncRelatedEntity( _componentInspectionReportType, new PropertyChangedEventHandler( OnComponentInspectionReportTypePropertyChanged ), "ComponentInspectionReportType", ComponentInspectionReportTypeEntity.Relations.ComponentInspectionReportTypeEntityUsingComponentInspectionReportTypeIdParentComponentInspectionReportTypeId, true, signalRelatedEntity, "ComponentInspectionReportType_", resetFKFields, new int[] { (int)ComponentInspectionReportTypeFieldIndex.ParentComponentInspectionReportTypeId } );		
			_componentInspectionReportType = null;
		}
		...
		/// <param name="validator">The validator object for this ComponentInspectionReportTypeEntity</param>
		...
		public  static ComponentInspectionReportTypeRelations Relations
		{
			get	{ return new ComponentInspectionReportTypeRelations(); }
		}
		...
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'CirStandardTexts' 
		/// for this entity. Add the object returned by this property to an existing PrefetchPath2 instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathCirStandardTexts
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<CirStandardTextsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CirStandardTextsEntityFactory))),
					ComponentInspectionReportTypeEntity.Relations.CirStandardTextsEntityUsingComponentInspectionReportTypeId, 
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.CirStandardTextsEntity, 0, null, null, null, null, "CirStandardTexts", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReport
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ComponentInspectionReportEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportEntityFactory))),
					ComponentInspectionReportTypeEntity.Relations.ComponentInspectionReportEntityUsingComponentInspectionReportTypeId, 
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportEntity, 0, null, null, null, null, "ComponentInspectionReport", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		/// for this entity. Add the object returned by this property to an existing PrefetchPath2 instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportType_
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ComponentInspectionReportTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportTypeEntityFactory))),
					ComponentInspectionReportTypeEntity.Relations.ComponentInspectionReportTypeEntityUsingParentComponentInspectionReportTypeId, 
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, 0, null, null, null, null, "ComponentInspectionReportType_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'HotItem' 
		/// for this entity. Add the object returned by this property to an existing PrefetchPath2 instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathHotItem
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<HotItemEntity>(EntityFactoryCache2.GetEntityFactory(typeof(HotItemEntityFactory))),
					ComponentInspectionReportTypeEntity.Relations.HotItemEntityUsingComponentInspectionReportTypeId, 
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.HotItemEntity, 0, null, null, null, null, "HotItem", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBooleanAnswerCollectionViaComponentInspectionReport__
		{
			get
			{
				...
				IEntityRelation intermediateRelation = ComponentInspectionReportTypeEntity.Relations.ComponentInspectionReportEntityUsingComponentInspectionReportTypeId;
				intermediateRelation.SetAliases(string.Empty, "ComponentInspectionReport_");
				relations.Add(ComponentInspectionReportTypeEntity.Relations.ComponentInspectionReportEntityUsingComponentInspectionReportTypeId, "ComponentInspectionReportTypeEntity__", "ComponentInspectionReport_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<BooleanAnswerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BooleanAnswerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.BooleanAnswerEntity, 0, null, null, relations, null, "BooleanAnswerCollectionViaComponentInspectionReport__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBooleanAnswerCollectionViaComponentInspectionReport_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BooleanAnswerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BooleanAnswerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.BooleanAnswerEntity, 0, null, null, relations, null, "BooleanAnswerCollectionViaComponentInspectionReport_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBooleanAnswerCollectionViaComponentInspectionReport
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BooleanAnswerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BooleanAnswerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.BooleanAnswerEntity, 0, null, null, relations, null, "BooleanAnswerCollectionViaComponentInspectionReport", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCountryIsoCollectionViaComponentInspectionReport
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CountryIsoEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CountryIsoEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.CountryIsoEntity, 0, null, null, relations, null, "CountryIsoCollectionViaComponentInspectionReport", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathLocationTypeCollectionViaComponentInspectionReport
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<LocationTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(LocationTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.LocationTypeEntity, 0, null, null, relations, null, "LocationTypeCollectionViaComponentInspectionReport", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathReportTypeCollectionViaComponentInspectionReport
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ReportTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ReportTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.ReportTypeEntity, 0, null, null, relations, null, "ReportTypeCollectionViaComponentInspectionReport", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathSbuCollectionViaComponentInspectionReport
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<SbuEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SbuEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.SbuEntity, 0, null, null, relations, null, "SbuCollectionViaComponentInspectionReport", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathServiceReportNumberTypeCollectionViaComponentInspectionReport
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ServiceReportNumberTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ServiceReportNumberTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.ServiceReportNumberTypeEntity, 0, null, null, relations, null, "ServiceReportNumberTypeCollectionViaComponentInspectionReport", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineMatrixCollectionViaComponentInspectionReport
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineMatrixEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineMatrixEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineMatrixEntity, 0, null, null, relations, null, "TurbineMatrixCollectionViaComponentInspectionReport", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineRunStatusCollectionViaComponentInspectionReport_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineRunStatusEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineRunStatusEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineRunStatusEntity, 0, null, null, relations, null, "TurbineRunStatusCollectionViaComponentInspectionReport_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineRunStatusCollectionViaComponentInspectionReport
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineRunStatusEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineRunStatusEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineRunStatusEntity, 0, null, null, relations, null, "TurbineRunStatusCollectionViaComponentInspectionReport", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportType
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportTypeEntityFactory))),
					ComponentInspectionReportTypeEntity.Relations.ComponentInspectionReportTypeEntityUsingComponentInspectionReportTypeIdParentComponentInspectionReportTypeId, 
					(int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity, 0, null, null, null, null, "ComponentInspectionReportType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return ComponentInspectionReportTypeEntity.CustomProperties;}
		}
		...
		{
			get { return ComponentInspectionReportTypeEntity.FieldsCustomProperties;}
		}

		/// <summary> The ComponentInspectionReportTypeId property of the Entity ComponentInspectionReportType<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ComponentInspectionReportType"."ComponentInspectionReportTypeId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 ComponentInspectionReportTypeId
		{
			get { return (System.Int64)GetValue((int)ComponentInspectionReportTypeFieldIndex.ComponentInspectionReportTypeId, true); }
			set	{ SetValue((int)ComponentInspectionReportTypeFieldIndex.ComponentInspectionReportTypeId, value); }
		}

		/// <summary> The Name property of the Entity ComponentInspectionReportType<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ComponentInspectionReportType"."Name"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)ComponentInspectionReportTypeFieldIndex.Name, true); }
			set	{ SetValue((int)ComponentInspectionReportTypeFieldIndex.Name, value); }
		}

		/// <summary> The LanguageId property of the Entity ComponentInspectionReportType<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ComponentInspectionReportType"."LanguageId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 LanguageId
		{
			get { return (System.Int64)GetValue((int)ComponentInspectionReportTypeFieldIndex.LanguageId, true); }
			set	{ SetValue((int)ComponentInspectionReportTypeFieldIndex.LanguageId, value); }
		}

		/// <summary> The ParentComponentInspectionReportTypeId property of the Entity ComponentInspectionReportType<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ComponentInspectionReportType"."ParentComponentInspectionReportTypeId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> ParentComponentInspectionReportTypeId
		{
			get { return (Nullable<System.Int64>)GetValue((int)ComponentInspectionReportTypeFieldIndex.ParentComponentInspectionReportTypeId, false); }
			set	{ SetValue((int)ComponentInspectionReportTypeFieldIndex.ParentComponentInspectionReportTypeId, value); }
		}

		/// <summary> The Sort property of the Entity ComponentInspectionReportType<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ComponentInspectionReportType"."Sort"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 Sort
		{
			get { return (System.Int64)GetValue((int)ComponentInspectionReportTypeFieldIndex.Sort, true); }
			set	{ SetValue((int)ComponentInspectionReportTypeFieldIndex.Sort, value); }
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'CirStandardTextsEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(CirStandardTextsEntity))]
		public virtual EntityCollection<CirStandardTextsEntity> CirStandardTexts
		{
			get
			{
				if(_cirStandardTexts==null)
				{
					_cirStandardTexts = new EntityCollection<CirStandardTextsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CirStandardTextsEntityFactory)));
					_cirStandardTexts.SetContainingEntityInfo(this, "ComponentInspectionReportType");
				}
				return _cirStandardTexts;
			}
		}
		...
		public virtual EntityCollection<ComponentInspectionReportEntity> ComponentInspectionReport
		{
			get
			{
				if(_componentInspectionReport==null)
				{
					...
					_componentInspectionReport.SetContainingEntityInfo(this, "ComponentInspectionReportType");
				}
				return _componentInspectionReport;
			}
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'ComponentInspectionReportTypeEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(ComponentInspectionReportTypeEntity))]
		public virtual EntityCollection<ComponentInspectionReportTypeEntity> ComponentInspectionReportType_
		{
			get
			{
				if(_componentInspectionReportType_==null)
				{
					_componentInspectionReportType_ = new EntityCollection<ComponentInspectionReportTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportTypeEntityFactory)));
					_componentInspectionReportType_.SetContainingEntityInfo(this, "ComponentInspectionReportType");
				}
				return _componentInspectionReportType_;
			}
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'HotItemEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(HotItemEntity))]
		public virtual EntityCollection<HotItemEntity> HotItem
		{
			get
			{
				if(_hotItem==null)
				{
					_hotItem = new EntityCollection<HotItemEntity>(EntityFactoryCache2.GetEntityFactory(typeof(HotItemEntityFactory)));
					_hotItem.SetContainingEntityInfo(this, "ComponentInspectionReportType");
				}
				return _hotItem;
			}
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_componentInspectionReportType != null)
						{
							_componentInspectionReportType.UnsetRelatedEntity(this, "ComponentInspectionReportType_");
						}
					}
					else
					{
						((IEntity2)value).SetRelatedEntity(this, "ComponentInspectionReportType_");
					}
				}
			}
		}
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTypeEntity; }
		}
		#endregion
