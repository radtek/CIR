...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'BladeColor'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class BladeColorEntity : CommonEntityBase, ISerializable
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfaces
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private EntityCollection<BladeColorEntity> _bladeColor_;
		...
		public static class MemberNames
		{
			...
			/// <summary>Member name BladeColor_</summary>
			public static readonly string BladeColor_ = "BladeColor_";
		...
		static BladeColorEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public BladeColorEntity():base("BladeColorEntity")
		{
		...
		public BladeColorEntity(IEntityFields2 fields):base("BladeColorEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this BladeColorEntity</param>
		public BladeColorEntity(IValidator validator):base("BladeColorEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="bladeColorId">PK value for BladeColor which data should be fetched into this BladeColor object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public BladeColorEntity(System.Int64 bladeColorId):base("BladeColorEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.BladeColorId = bladeColorId;
		}
		...
		/// <param name="validator">The custom validator object for this BladeColorEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public BladeColorEntity(System.Int64 bladeColorId, IValidator validator):base("BladeColorEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.BladeColorId = bladeColorId;
		}
		...
		protected BladeColorEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				_bladeColor_ = (EntityCollection<BladeColorEntity>)info.GetValue("_bladeColor_", typeof(EntityCollection<BladeColorEntity>));
		...
		{
			switch((BladeColorFieldIndex)fieldIndex)
			{
				case BladeColorFieldIndex.ParentBladeColorId:
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				case "BladeColor":
					...
					break;
				case "BladeColor_":
					this.BladeColor_.Add((BladeColorEntity)entity);
					break;
		...
		public override void SetRelatedEntity(IEntity2 relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				case "BladeColor":
					...
					break;
				case "BladeColor_":
					this.BladeColor_.Add((BladeColorEntity)relatedEntity);
					OnRelatedEntitySet(relatedEntity, fieldName);
					break;
				case "ComponentInspectionReportBlade":
		...
		public override void UnsetRelatedEntity(IEntity2 relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				case "BladeColor":
					...
					break;
				case "BladeColor_":
					base.PerformRelatedEntityRemoval(this.BladeColor_, relatedEntity, signalRelatedEntityManyToOne);
					OnRelatedEntityUnset(relatedEntity, fieldName);
					break;
				case "ComponentInspectionReportBlade":
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_bladeColor_", ((_bladeColor_!=null) && (_bladeColor_.Count>0) && !this.MarkedForDeletion)?_bladeColor_:null);
		...
		public bool TestOriginalFieldValueForNull(BladeColorFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(BladeColorFieldIndex fieldIndex)
		{
		...
		{
			return new BladeColorRelations().GetAllRelations();
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoBladeColor_()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(BladeColorFields.ParentBladeColorId, null, ComparisonOperator.Equal, this.BladeColorId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentInspectionReportBladeFields.BladeColorId, null, ComparisonOperator.Equal, this.BladeColorId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(BladeColorEntity.Relations.ComponentInspectionReportBladeEntityUsingBladeColorId, "BladeColorEntity__", "ComponentInspectionReportBlade_", JoinHint.None);
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(BladeColorFields.BladeColorId, null, ComparisonOperator.Equal, this.BladeColorId, "BladeColorEntity__"));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(BladeColorFields.BladeColorId, null, ComparisonOperator.Equal, this.ParentBladeColorId));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.BladeColorEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(BladeColorEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._bladeColor_);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._bladeColor_ = (EntityCollection<BladeColorEntity>) collectionsQueue.Dequeue();
		...
		public override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("BladeColor_", _bladeColor_);
		...
		{
			if(_bladeColor_!=null)
			{
				_bladeColor_.ActiveContext = base.ActiveContext;
			}
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ParentBladeColorId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			base.PerformDesetupSyncRelatedEntity( _bladeColor, new PropertyChangedEventHandler( OnBladeColorPropertyChanged ), "BladeColor", BladeColorEntity.Relations.BladeColorEntityUsingBladeColorIdParentBladeColorId, true, signalRelatedEntity, "BladeColor_", resetFKFields, new int[] { (int)BladeColorFieldIndex.ParentBladeColorId } );		
			_bladeColor = null;
		}
		...
		private void SetupSyncBladeColor(IEntity2 relatedEntity)
		{
			...
			base.PerformSetupSyncRelatedEntity( _bladeColor, new PropertyChangedEventHandler( OnBladeColorPropertyChanged ), "BladeColor", BladeColorEntity.Relations.BladeColorEntityUsingBladeColorIdParentBladeColorId, true, new string[] {  } );
		}
		...
		/// <param name="validator">The validator object for this BladeColorEntity</param>
		...
		public  static BladeColorRelations Relations
		{
			get	{ return new BladeColorRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBladeColor_
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<BladeColorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BladeColorEntityFactory))),
					BladeColorEntity.Relations.BladeColorEntityUsingParentBladeColorId, 
					(int)Cir.Data.LLBLGen.EntityType.BladeColorEntity, (int)Cir.Data.LLBLGen.EntityType.BladeColorEntity, 0, null, null, null, null, "BladeColor_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportBlade
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ComponentInspectionReportBladeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportBladeEntityFactory))),
					BladeColorEntity.Relations.ComponentInspectionReportBladeEntityUsingBladeColorId, 
					(int)Cir.Data.LLBLGen.EntityType.BladeColorEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportBladeEntity, 0, null, null, null, null, "ComponentInspectionReportBlade", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBladeLengthCollectionViaComponentInspectionReportBlade
		{
			get
			{
				...
				IEntityRelation intermediateRelation = BladeColorEntity.Relations.ComponentInspectionReportBladeEntityUsingBladeColorId;
				intermediateRelation.SetAliases(string.Empty, "ComponentInspectionReportBlade_");
				relations.Add(BladeColorEntity.Relations.ComponentInspectionReportBladeEntityUsingBladeColorId, "BladeColorEntity__", "ComponentInspectionReportBlade_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<BladeLengthEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BladeLengthEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.BladeColorEntity, (int)Cir.Data.LLBLGen.EntityType.BladeLengthEntity, 0, null, null, relations, null, "BladeLengthCollectionViaComponentInspectionReportBlade", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBooleanAnswerCollectionViaComponentInspectionReportBlade_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BooleanAnswerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BooleanAnswerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.BladeColorEntity, (int)Cir.Data.LLBLGen.EntityType.BooleanAnswerEntity, 0, null, null, relations, null, "BooleanAnswerCollectionViaComponentInspectionReportBlade_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBooleanAnswerCollectionViaComponentInspectionReportBlade
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BooleanAnswerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BooleanAnswerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.BladeColorEntity, (int)Cir.Data.LLBLGen.EntityType.BooleanAnswerEntity, 0, null, null, relations, null, "BooleanAnswerCollectionViaComponentInspectionReportBlade", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportCollectionViaComponentInspectionReportBlade
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ComponentInspectionReportEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.BladeColorEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportEntity, 0, null, null, relations, null, "ComponentInspectionReportCollectionViaComponentInspectionReportBlade", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFaultCodeAreaCollectionViaComponentInspectionReportBlade
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<FaultCodeAreaEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FaultCodeAreaEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.BladeColorEntity, (int)Cir.Data.LLBLGen.EntityType.FaultCodeAreaEntity, 0, null, null, relations, null, "FaultCodeAreaCollectionViaComponentInspectionReportBlade", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFaultCodeCauseCollectionViaComponentInspectionReportBlade
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<FaultCodeCauseEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FaultCodeCauseEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.BladeColorEntity, (int)Cir.Data.LLBLGen.EntityType.FaultCodeCauseEntity, 0, null, null, relations, null, "FaultCodeCauseCollectionViaComponentInspectionReportBlade", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFaultCodeClassificationCollectionViaComponentInspectionReportBlade
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<FaultCodeClassificationEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FaultCodeClassificationEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.BladeColorEntity, (int)Cir.Data.LLBLGen.EntityType.FaultCodeClassificationEntity, 0, null, null, relations, null, "FaultCodeClassificationCollectionViaComponentInspectionReportBlade", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFaultCodeTypeCollectionViaComponentInspectionReportBlade
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<FaultCodeTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FaultCodeTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.BladeColorEntity, (int)Cir.Data.LLBLGen.EntityType.FaultCodeTypeEntity, 0, null, null, relations, null, "FaultCodeTypeCollectionViaComponentInspectionReportBlade", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBladeColor
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(BladeColorEntityFactory))),
					BladeColorEntity.Relations.BladeColorEntityUsingBladeColorIdParentBladeColorId, 
					(int)Cir.Data.LLBLGen.EntityType.BladeColorEntity, (int)Cir.Data.LLBLGen.EntityType.BladeColorEntity, 0, null, null, null, null, "BladeColor", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return BladeColorEntity.CustomProperties;}
		}
		...
		{
			get { return BladeColorEntity.FieldsCustomProperties;}
		}

		/// <summary> The BladeColorId property of the Entity BladeColor<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BladeColor"."BladeColorId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 BladeColorId
		{
			get { return (System.Int64)GetValue((int)BladeColorFieldIndex.BladeColorId, true); }
			set	{ SetValue((int)BladeColorFieldIndex.BladeColorId, value); }
		}

		/// <summary> The Name property of the Entity BladeColor<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BladeColor"."Name"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)BladeColorFieldIndex.Name, true); }
			set	{ SetValue((int)BladeColorFieldIndex.Name, value); }
		}

		/// <summary> The LanguageId property of the Entity BladeColor<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BladeColor"."LanguageId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 LanguageId
		{
			get { return (System.Int64)GetValue((int)BladeColorFieldIndex.LanguageId, true); }
			set	{ SetValue((int)BladeColorFieldIndex.LanguageId, value); }
		}

		/// <summary> The ParentBladeColorId property of the Entity BladeColor<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BladeColor"."ParentBladeColorId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> ParentBladeColorId
		{
			get { return (Nullable<System.Int64>)GetValue((int)BladeColorFieldIndex.ParentBladeColorId, false); }
			set	{ SetValue((int)BladeColorFieldIndex.ParentBladeColorId, value); }
		}

		/// <summary> The Sort property of the Entity BladeColor<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BladeColor"."Sort"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 Sort
		{
			get { return (System.Int64)GetValue((int)BladeColorFieldIndex.Sort, true); }
			set	{ SetValue((int)BladeColorFieldIndex.Sort, value); }
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'BladeColorEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(BladeColorEntity))]
		public virtual EntityCollection<BladeColorEntity> BladeColor_
		{
			get
			{
				if(_bladeColor_==null)
				{
					_bladeColor_ = new EntityCollection<BladeColorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BladeColorEntityFactory)));
					_bladeColor_.SetContainingEntityInfo(this, "BladeColor");
				}
				return _bladeColor_;
			}
		}
		...
		public virtual EntityCollection<ComponentInspectionReportBladeEntity> ComponentInspectionReportBlade
		{
			get
			{
				if(_componentInspectionReportBlade==null)
				{
					...
					_componentInspectionReportBlade.SetContainingEntityInfo(this, "BladeColor");
				}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_bladeColor != null)
						{
							_bladeColor.UnsetRelatedEntity(this, "BladeColor_");
						}
					}
					else
					{
						((IEntity2)value).SetRelatedEntity(this, "BladeColor_");
					}
				}
			}
		}
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.BladeColorEntity; }
		}
		#endregion
