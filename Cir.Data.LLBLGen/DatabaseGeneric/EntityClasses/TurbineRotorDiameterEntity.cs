...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'TurbineRotorDiameter'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class TurbineRotorDiameterEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static TurbineRotorDiameterEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public TurbineRotorDiameterEntity():base("TurbineRotorDiameterEntity")
		{
		...
		public TurbineRotorDiameterEntity(IEntityFields2 fields):base("TurbineRotorDiameterEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this TurbineRotorDiameterEntity</param>
		public TurbineRotorDiameterEntity(IValidator validator):base("TurbineRotorDiameterEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="turbineRotorDiameterId">PK value for TurbineRotorDiameter which data should be fetched into this TurbineRotorDiameter object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TurbineRotorDiameterEntity(System.Int64 turbineRotorDiameterId):base("TurbineRotorDiameterEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.TurbineRotorDiameterId = turbineRotorDiameterId;
		}
		...
		/// <param name="validator">The custom validator object for this TurbineRotorDiameterEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TurbineRotorDiameterEntity(System.Int64 turbineRotorDiameterId, IValidator validator):base("TurbineRotorDiameterEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.TurbineRotorDiameterId = turbineRotorDiameterId;
		}
		...
		protected TurbineRotorDiameterEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((TurbineRotorDiameterFieldIndex)fieldIndex)
			{
				default:
		...
		public bool TestOriginalFieldValueForNull(TurbineRotorDiameterFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(TurbineRotorDiameterFieldIndex fieldIndex)
		{
		...
		{
			return new TurbineRotorDiameterRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoTurbineMatrix()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TurbineMatrixFields.TurbineRotorDiameterId, null, ComparisonOperator.Equal, this.TurbineRotorDiameterId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(TurbineRotorDiameterEntity.Relations.TurbineMatrixEntityUsingTurbineRotorDiameterId, "TurbineRotorDiameterEntity__", "TurbineMatrix_", JoinHint.None);
			bucket.Relations.Add(TurbineMatrixEntity.Relations.TurbineEntityUsingTurbineId, "TurbineMatrix_", string.Empty, JoinHint.None);
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TurbineRotorDiameterFields.TurbineRotorDiameterId, null, ComparisonOperator.Equal, this.TurbineRotorDiameterId, "TurbineRotorDiameterEntity__"));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(TurbineRotorDiameterEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this TurbineRotorDiameterEntity</param>
		...
		public  static TurbineRotorDiameterRelations Relations
		{
			get	{ return new TurbineRotorDiameterRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineMatrix
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<TurbineMatrixEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineMatrixEntityFactory))),
					TurbineRotorDiameterEntity.Relations.TurbineMatrixEntityUsingTurbineRotorDiameterId, 
					(int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineMatrixEntity, 0, null, null, null, null, "TurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineCollectionViaTurbineMatrix
		{
			get
			{
				...
				IEntityRelation intermediateRelation = TurbineRotorDiameterEntity.Relations.TurbineMatrixEntityUsingTurbineRotorDiameterId;
				intermediateRelation.SetAliases(string.Empty, "TurbineMatrix_");
				relations.Add(TurbineRotorDiameterEntity.Relations.TurbineMatrixEntityUsingTurbineRotorDiameterId, "TurbineRotorDiameterEntity__", "TurbineMatrix_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineEntity, 0, null, null, relations, null, "TurbineCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineFrequencyCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineFrequencyEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineFrequencyEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, 0, null, null, relations, null, "TurbineFrequencyCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineManufacturerCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineManufacturerEntity, 0, null, null, relations, null, "TurbineManufacturerCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineMarkVersionCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineMarkVersionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineMarkVersionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineMarkVersionEntity, 0, null, null, relations, null, "TurbineMarkVersionCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineNominelPowerCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineNominelPowerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineNominelPowerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineNominelPowerEntity, 0, null, null, relations, null, "TurbineNominelPowerCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineOldCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineOldEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineOldEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, 0, null, null, relations, null, "TurbineOldCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbinePlacementCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbinePlacementEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbinePlacementEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, (int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, 0, null, null, relations, null, "TurbinePlacementCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbinePowerRegulationCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbinePowerRegulationEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbinePowerRegulationEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, (int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, 0, null, null, relations, null, "TurbinePowerRegulationCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineSmallGeneratorCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineSmallGeneratorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineSmallGeneratorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, 0, null, null, relations, null, "TurbineSmallGeneratorCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineTemperatureVariantCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineTemperatureVariantEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineTemperatureVariantEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, 0, null, null, relations, null, "TurbineTemperatureVariantCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineVoltageCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineVoltageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineVoltageEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineVoltageEntity, 0, null, null, relations, null, "TurbineVoltageCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return TurbineRotorDiameterEntity.CustomProperties;}
		}
		...
		{
			get { return TurbineRotorDiameterEntity.FieldsCustomProperties;}
		}

		/// <summary> The TurbineRotorDiameterId property of the Entity TurbineRotorDiameter<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineRotorDiameter"."TurbineRotorDiameterId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 TurbineRotorDiameterId
		{
			get { return (System.Int64)GetValue((int)TurbineRotorDiameterFieldIndex.TurbineRotorDiameterId, true); }
			set	{ SetValue((int)TurbineRotorDiameterFieldIndex.TurbineRotorDiameterId, value); }
		}

		/// <summary> The RotorDiameter property of the Entity TurbineRotorDiameter<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineRotorDiameter"."RotorDiameter"<br/>
		/// Table field type characteristics (type, precision, scale, length): Decimal, 5, 2, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Decimal RotorDiameter
		{
			get { return (System.Decimal)GetValue((int)TurbineRotorDiameterFieldIndex.RotorDiameter, true); }
			set	{ SetValue((int)TurbineRotorDiameterFieldIndex.RotorDiameter, value); }
		}

		/// <summary> The Created property of the Entity TurbineRotorDiameter<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineRotorDiameter"."Created"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime Created
		{
			get { return (System.DateTime)GetValue((int)TurbineRotorDiameterFieldIndex.Created, true); }
			set	{ SetValue((int)TurbineRotorDiameterFieldIndex.Created, value); }
		}

		/// <summary> The CreatedBy property of the Entity TurbineRotorDiameter<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineRotorDiameter"."CreatedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String CreatedBy
		{
			get { return (System.String)GetValue((int)TurbineRotorDiameterFieldIndex.CreatedBy, true); }
			set	{ SetValue((int)TurbineRotorDiameterFieldIndex.CreatedBy, value); }
		}

		/// <summary> The Deleted property of the Entity TurbineRotorDiameter<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineRotorDiameter"."Deleted"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> Deleted
		{
			get { return (Nullable<System.DateTime>)GetValue((int)TurbineRotorDiameterFieldIndex.Deleted, false); }
			set	{ SetValue((int)TurbineRotorDiameterFieldIndex.Deleted, value); }
		}

		/// <summary> The DeletedBy property of the Entity TurbineRotorDiameter<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineRotorDiameter"."DeletedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String DeletedBy
		{
			get { return (System.String)GetValue((int)TurbineRotorDiameterFieldIndex.DeletedBy, true); }
			set	{ SetValue((int)TurbineRotorDiameterFieldIndex.DeletedBy, value); }
		}
		...
		public virtual EntityCollection<TurbineMatrixEntity> TurbineMatrix
		{
			get
			{
				if(_turbineMatrix==null)
				{
					...
					_turbineMatrix.SetContainingEntityInfo(this, "TurbineRotorDiameter");
				}
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity; }
		}
		#endregion
