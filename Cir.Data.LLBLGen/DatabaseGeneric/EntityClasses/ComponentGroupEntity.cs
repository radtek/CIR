...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ComponentGroup'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ComponentGroupEntity : CommonEntityBase, ISerializable
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfaces
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private EntityCollection<ComponentGroupEntity> _componentGroup_;
		...
		public static class MemberNames
		{
			...
			/// <summary>Member name ComponentGroup_</summary>
			public static readonly string ComponentGroup_ = "ComponentGroup_";
		...
		static ComponentGroupEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public ComponentGroupEntity():base("ComponentGroupEntity")
		{
		...
		public ComponentGroupEntity(IEntityFields2 fields):base("ComponentGroupEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ComponentGroupEntity</param>
		public ComponentGroupEntity(IValidator validator):base("ComponentGroupEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="componentGroupId">PK value for ComponentGroup which data should be fetched into this ComponentGroup object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ComponentGroupEntity(System.Int64 componentGroupId):base("ComponentGroupEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this ComponentGroupEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ComponentGroupEntity(System.Int64 componentGroupId, IValidator validator):base("ComponentGroupEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.ComponentGroupId = componentGroupId;
		}
		...
		protected ComponentGroupEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				_componentGroup_ = (EntityCollection<ComponentGroupEntity>)info.GetValue("_componentGroup_", typeof(EntityCollection<ComponentGroupEntity>));
		...
		{
			switch((ComponentGroupFieldIndex)fieldIndex)
			{
				case ComponentGroupFieldIndex.ParentComponentGroupId:
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				case "ComponentGroup":
					...
					break;
				case "ComponentGroup_":
					this.ComponentGroup_.Add((ComponentGroupEntity)entity);
					break;
		...
		public override void SetRelatedEntity(IEntity2 relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				case "ComponentGroup":
					...
					break;
				case "ComponentGroup_":
					this.ComponentGroup_.Add((ComponentGroupEntity)relatedEntity);
					OnRelatedEntitySet(relatedEntity, fieldName);
					break;
				case "ComponentInspectionReportGeneral":
		...
		public override void UnsetRelatedEntity(IEntity2 relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				case "ComponentGroup":
					...
					break;
				case "ComponentGroup_":
					base.PerformRelatedEntityRemoval(this.ComponentGroup_, relatedEntity, signalRelatedEntityManyToOne);
					OnRelatedEntityUnset(relatedEntity, fieldName);
					break;
				case "ComponentInspectionReportGeneral":
		...
		public override List<IEntityCollection2> GetMemberEntityCollections()
		{
			...
			toReturn.Add(this.ComponentGroup_);
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_componentGroup_", ((_componentGroup_!=null) && (_componentGroup_.Count>0) && !this.MarkedForDeletion)?_componentGroup_:null);
		...
		public bool TestOriginalFieldValueForNull(ComponentGroupFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ComponentGroupFieldIndex fieldIndex)
		{
		...
		{
			return new ComponentGroupRelations().GetAllRelations();
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoComponentGroup_()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentGroupFields.ParentComponentGroupId, null, ComparisonOperator.Equal, this.ComponentGroupId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentInspectionReportGeneralFields.GeneralComponentGroupId, null, ComparisonOperator.Equal, this.ComponentGroupId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(ComponentGroupEntity.Relations.ComponentInspectionReportGeneralEntityUsingGeneralComponentGroupId, "ComponentGroupEntity__", "ComponentInspectionReportGeneral_", JoinHint.None);
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentGroupFields.ComponentGroupId, null, ComparisonOperator.Equal, this.ComponentGroupId, "ComponentGroupEntity__"));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentGroupFields.ComponentGroupId, null, ComparisonOperator.Equal, this.ParentComponentGroupId));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.ComponentGroupEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ComponentGroupEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._componentGroup_);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._componentGroup_ = (EntityCollection<ComponentGroupEntity>) collectionsQueue.Dequeue();
		...
		public override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("ComponentGroup_", _componentGroup_);
		...
		{
			if(_componentGroup_!=null)
			{
				_componentGroup_.ActiveContext = base.ActiveContext;
			}
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ComponentGroupId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			...
			_fieldsCustomProperties.Add("ParentComponentGroupId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			base.PerformDesetupSyncRelatedEntity( _componentGroup, new PropertyChangedEventHandler( OnComponentGroupPropertyChanged ), "ComponentGroup", ComponentGroupEntity.Relations.ComponentGroupEntityUsingComponentGroupIdParentComponentGroupId, true, signalRelatedEntity, "ComponentGroup_", resetFKFields, new int[] { (int)ComponentGroupFieldIndex.ParentComponentGroupId } );		
			_componentGroup = null;
		}
		...
		private void SetupSyncComponentGroup(IEntity2 relatedEntity)
		{
			...
			base.PerformSetupSyncRelatedEntity( _componentGroup, new PropertyChangedEventHandler( OnComponentGroupPropertyChanged ), "ComponentGroup", ComponentGroupEntity.Relations.ComponentGroupEntityUsingComponentGroupIdParentComponentGroupId, true, new string[] {  } );
		}
		...
		/// <param name="validator">The validator object for this ComponentGroupEntity</param>
		...
		public  static ComponentGroupRelations Relations
		{
			get	{ return new ComponentGroupRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentGroup_
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ComponentGroupEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentGroupEntityFactory))),
					ComponentGroupEntity.Relations.ComponentGroupEntityUsingParentComponentGroupId, 
					(int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity, 0, null, null, null, null, "ComponentGroup_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportGeneral
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ComponentInspectionReportGeneralEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportGeneralEntityFactory))),
					ComponentGroupEntity.Relations.ComponentInspectionReportGeneralEntityUsingGeneralComponentGroupId, 
					(int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportGeneralEntity, 0, null, null, null, null, "ComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBooleanAnswerCollectionViaComponentInspectionReportGeneral_
		{
			get
			{
				...
				IEntityRelation intermediateRelation = ComponentGroupEntity.Relations.ComponentInspectionReportGeneralEntityUsingGeneralComponentGroupId;
				intermediateRelation.SetAliases(string.Empty, "ComponentInspectionReportGeneral_");
				relations.Add(ComponentGroupEntity.Relations.ComponentInspectionReportGeneralEntityUsingGeneralComponentGroupId, "ComponentGroupEntity__", "ComponentInspectionReportGeneral_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<BooleanAnswerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BooleanAnswerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity, (int)Cir.Data.LLBLGen.EntityType.BooleanAnswerEntity, 0, null, null, relations, null, "BooleanAnswerCollectionViaComponentInspectionReportGeneral_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBooleanAnswerCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BooleanAnswerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BooleanAnswerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity, (int)Cir.Data.LLBLGen.EntityType.BooleanAnswerEntity, 0, null, null, relations, null, "BooleanAnswerCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ComponentInspectionReportEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportEntity, 0, null, null, relations, null, "ComponentInspectionReportCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathControllerTypeCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ControllerTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ControllerTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity, (int)Cir.Data.LLBLGen.EntityType.ControllerTypeEntity, 0, null, null, relations, null, "ControllerTypeCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearboxManufacturerCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearboxManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearboxManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity, (int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, 0, null, null, relations, null, "GearboxManufacturerCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGeneratorManufacturerCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GeneratorManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity, (int)Cir.Data.LLBLGen.EntityType.GeneratorManufacturerEntity, 0, null, null, relations, null, "GeneratorManufacturerCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTowerHeightCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TowerHeightEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TowerHeightEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity, (int)Cir.Data.LLBLGen.EntityType.TowerHeightEntity, 0, null, null, relations, null, "TowerHeightCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTowerTypeCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TowerTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TowerTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity, (int)Cir.Data.LLBLGen.EntityType.TowerTypeEntity, 0, null, null, relations, null, "TowerTypeCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTransformerManufacturerCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TransformerManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TransformerManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity, (int)Cir.Data.LLBLGen.EntityType.TransformerManufacturerEntity, 0, null, null, relations, null, "TransformerManufacturerCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentGroup
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ComponentGroupEntityFactory))),
					ComponentGroupEntity.Relations.ComponentGroupEntityUsingComponentGroupIdParentComponentGroupId, 
					(int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity, 0, null, null, null, null, "ComponentGroup", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return ComponentGroupEntity.CustomProperties;}
		}
		...
		{
			get { return ComponentGroupEntity.FieldsCustomProperties;}
		}

		/// <summary> The ComponentGroupId property of the Entity ComponentGroup<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ComponentGroup"."ComponentGroupId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 ComponentGroupId
		{
			get { return (System.Int64)GetValue((int)ComponentGroupFieldIndex.ComponentGroupId, true); }
			set	{ SetValue((int)ComponentGroupFieldIndex.ComponentGroupId, value); }
		}

		/// <summary> The Name property of the Entity ComponentGroup<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ComponentGroup"."Name"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)ComponentGroupFieldIndex.Name, true); }
			set	{ SetValue((int)ComponentGroupFieldIndex.Name, value); }
		}

		/// <summary> The LanguageId property of the Entity ComponentGroup<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ComponentGroup"."LanguageId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 LanguageId
		{
			get { return (System.Int64)GetValue((int)ComponentGroupFieldIndex.LanguageId, true); }
			set	{ SetValue((int)ComponentGroupFieldIndex.LanguageId, value); }
		}

		/// <summary> The ParentComponentGroupId property of the Entity ComponentGroup<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ComponentGroup"."ParentComponentGroupId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> ParentComponentGroupId
		{
			get { return (Nullable<System.Int64>)GetValue((int)ComponentGroupFieldIndex.ParentComponentGroupId, false); }
			set	{ SetValue((int)ComponentGroupFieldIndex.ParentComponentGroupId, value); }
		}

		/// <summary> The Sort property of the Entity ComponentGroup<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ComponentGroup"."Sort"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 Sort
		{
			get { return (System.Int64)GetValue((int)ComponentGroupFieldIndex.Sort, true); }
			set	{ SetValue((int)ComponentGroupFieldIndex.Sort, value); }
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'ComponentGroupEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(ComponentGroupEntity))]
		public virtual EntityCollection<ComponentGroupEntity> ComponentGroup_
		{
			get
			{
				if(_componentGroup_==null)
				{
					_componentGroup_ = new EntityCollection<ComponentGroupEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentGroupEntityFactory)));
					_componentGroup_.SetContainingEntityInfo(this, "ComponentGroup");
				}
				return _componentGroup_;
			}
		}
		...
		public virtual EntityCollection<ComponentInspectionReportGeneralEntity> ComponentInspectionReportGeneral
		{
			get
			{
				if(_componentInspectionReportGeneral==null)
				{
					...
					_componentInspectionReportGeneral.SetContainingEntityInfo(this, "ComponentGroup");
				}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_componentGroup != null)
						{
							_componentGroup.UnsetRelatedEntity(this, "ComponentGroup_");
						}
					}
					else
					{
						((IEntity2)value).SetRelatedEntity(this, "ComponentGroup_");
					}
				}
			}
		}
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity; }
		}
		#endregion
