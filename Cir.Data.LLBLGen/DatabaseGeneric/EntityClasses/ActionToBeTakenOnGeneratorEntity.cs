...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ActionToBeTakenOnGenerator'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ActionToBeTakenOnGeneratorEntity : CommonEntityBase, ISerializable
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfaces
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private EntityCollection<ActionToBeTakenOnGeneratorEntity> _actionToBeTakenOnGenerator_;
		...
		public static class MemberNames
		{
			...
			/// <summary>Member name ActionToBeTakenOnGenerator_</summary>
			public static readonly string ActionToBeTakenOnGenerator_ = "ActionToBeTakenOnGenerator_";
		...
		static ActionToBeTakenOnGeneratorEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public ActionToBeTakenOnGeneratorEntity():base("ActionToBeTakenOnGeneratorEntity")
		{
		...
		public ActionToBeTakenOnGeneratorEntity(IEntityFields2 fields):base("ActionToBeTakenOnGeneratorEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ActionToBeTakenOnGeneratorEntity</param>
		public ActionToBeTakenOnGeneratorEntity(IValidator validator):base("ActionToBeTakenOnGeneratorEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="actionToBeTakenOnGeneratorId">PK value for ActionToBeTakenOnGenerator which data should be fetched into this ActionToBeTakenOnGenerator object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ActionToBeTakenOnGeneratorEntity(System.Int64 actionToBeTakenOnGeneratorId):base("ActionToBeTakenOnGeneratorEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.ActionToBeTakenOnGeneratorId = actionToBeTakenOnGeneratorId;
		}
		...
		/// <param name="validator">The custom validator object for this ActionToBeTakenOnGeneratorEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ActionToBeTakenOnGeneratorEntity(System.Int64 actionToBeTakenOnGeneratorId, IValidator validator):base("ActionToBeTakenOnGeneratorEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.ActionToBeTakenOnGeneratorId = actionToBeTakenOnGeneratorId;
		}
		...
		protected ActionToBeTakenOnGeneratorEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				_actionToBeTakenOnGenerator_ = (EntityCollection<ActionToBeTakenOnGeneratorEntity>)info.GetValue("_actionToBeTakenOnGenerator_", typeof(EntityCollection<ActionToBeTakenOnGeneratorEntity>));
		...
		{
			switch((ActionToBeTakenOnGeneratorFieldIndex)fieldIndex)
			{
				case ActionToBeTakenOnGeneratorFieldIndex.ParentActionToBeTakenOnGeneratorId:
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				case "ActionToBeTakenOnGenerator":
					...
					break;
				case "ActionToBeTakenOnGenerator_":
					this.ActionToBeTakenOnGenerator_.Add((ActionToBeTakenOnGeneratorEntity)entity);
					break;
		...
		public override void SetRelatedEntity(IEntity2 relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				case "ActionToBeTakenOnGenerator":
					...
					break;
				case "ActionToBeTakenOnGenerator_":
					this.ActionToBeTakenOnGenerator_.Add((ActionToBeTakenOnGeneratorEntity)relatedEntity);
					OnRelatedEntitySet(relatedEntity, fieldName);
					break;
				case "ComponentInspectionReportGenerator":
		...
		public override void UnsetRelatedEntity(IEntity2 relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				case "ActionToBeTakenOnGenerator":
					...
					break;
				case "ActionToBeTakenOnGenerator_":
					base.PerformRelatedEntityRemoval(this.ActionToBeTakenOnGenerator_, relatedEntity, signalRelatedEntityManyToOne);
					OnRelatedEntityUnset(relatedEntity, fieldName);
					break;
				case "ComponentInspectionReportGenerator":
		...
		public override List<IEntityCollection2> GetMemberEntityCollections()
		{
			...
			toReturn.Add(this.ActionToBeTakenOnGenerator_);
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_actionToBeTakenOnGenerator_", ((_actionToBeTakenOnGenerator_!=null) && (_actionToBeTakenOnGenerator_.Count>0) && !this.MarkedForDeletion)?_actionToBeTakenOnGenerator_:null);
		...
		public bool TestOriginalFieldValueForNull(ActionToBeTakenOnGeneratorFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ActionToBeTakenOnGeneratorFieldIndex fieldIndex)
		{
		...
		{
			return new ActionToBeTakenOnGeneratorRelations().GetAllRelations();
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoActionToBeTakenOnGenerator_()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ActionToBeTakenOnGeneratorFields.ParentActionToBeTakenOnGeneratorId, null, ComparisonOperator.Equal, this.ActionToBeTakenOnGeneratorId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentInspectionReportGeneratorFields.ActionToBeTakenOnGeneratorId, null, ComparisonOperator.Equal, this.ActionToBeTakenOnGeneratorId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(ActionToBeTakenOnGeneratorEntity.Relations.ComponentInspectionReportGeneratorEntityUsingActionToBeTakenOnGeneratorId, "ActionToBeTakenOnGeneratorEntity__", "ComponentInspectionReportGenerator_", JoinHint.None);
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ActionToBeTakenOnGeneratorFields.ActionToBeTakenOnGeneratorId, null, ComparisonOperator.Equal, this.ActionToBeTakenOnGeneratorId, "ActionToBeTakenOnGeneratorEntity__"));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ActionToBeTakenOnGeneratorFields.ActionToBeTakenOnGeneratorId, null, ComparisonOperator.Equal, this.ParentActionToBeTakenOnGeneratorId));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ActionToBeTakenOnGeneratorEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._actionToBeTakenOnGenerator_);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._actionToBeTakenOnGenerator_ = (EntityCollection<ActionToBeTakenOnGeneratorEntity>) collectionsQueue.Dequeue();
		...
		{
			if (this._actionToBeTakenOnGenerator_ != null)
			{
				return true;
			}
		...
		public override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("ActionToBeTakenOnGenerator_", _actionToBeTakenOnGenerator_);
		...
		{
			if(_actionToBeTakenOnGenerator_!=null)
			{
				_actionToBeTakenOnGenerator_.ActiveContext = base.ActiveContext;
			}
		...
		protected virtual void InitClassMembers()
		{
			...
			_actionToBeTakenOnGenerator_ = null;
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ParentActionToBeTakenOnGeneratorId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			base.PerformDesetupSyncRelatedEntity( _actionToBeTakenOnGenerator, new PropertyChangedEventHandler( OnActionToBeTakenOnGeneratorPropertyChanged ), "ActionToBeTakenOnGenerator", ActionToBeTakenOnGeneratorEntity.Relations.ActionToBeTakenOnGeneratorEntityUsingActionToBeTakenOnGeneratorIdParentActionToBeTakenOnGeneratorId, true, signalRelatedEntity, "ActionToBeTakenOnGenerator_", resetFKFields, new int[] { (int)ActionToBeTakenOnGeneratorFieldIndex.ParentActionToBeTakenOnGeneratorId } );		
			_actionToBeTakenOnGenerator = null;
		}
		...
		private void SetupSyncActionToBeTakenOnGenerator(IEntity2 relatedEntity)
		{
			...
			base.PerformSetupSyncRelatedEntity( _actionToBeTakenOnGenerator, new PropertyChangedEventHandler( OnActionToBeTakenOnGeneratorPropertyChanged ), "ActionToBeTakenOnGenerator", ActionToBeTakenOnGeneratorEntity.Relations.ActionToBeTakenOnGeneratorEntityUsingActionToBeTakenOnGeneratorIdParentActionToBeTakenOnGeneratorId, true, new string[] {  } );
		}
		...
		/// <param name="validator">The validator object for this ActionToBeTakenOnGeneratorEntity</param>
		...
		public  static ActionToBeTakenOnGeneratorRelations Relations
		{
			get	{ return new ActionToBeTakenOnGeneratorRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathActionToBeTakenOnGenerator_
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ActionToBeTakenOnGeneratorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ActionToBeTakenOnGeneratorEntityFactory))),
					ActionToBeTakenOnGeneratorEntity.Relations.ActionToBeTakenOnGeneratorEntityUsingParentActionToBeTakenOnGeneratorId, 
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, 0, null, null, null, null, "ActionToBeTakenOnGenerator_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportGenerator
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ComponentInspectionReportGeneratorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportGeneratorEntityFactory))),
					ActionToBeTakenOnGeneratorEntity.Relations.ComponentInspectionReportGeneratorEntityUsingActionToBeTakenOnGeneratorId, 
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportGeneratorEntity, 0, null, null, null, null, "ComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBooleanAnswerCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				IEntityRelation intermediateRelation = ActionToBeTakenOnGeneratorEntity.Relations.ComponentInspectionReportGeneratorEntityUsingActionToBeTakenOnGeneratorId;
				intermediateRelation.SetAliases(string.Empty, "ComponentInspectionReportGenerator_");
				relations.Add(ActionToBeTakenOnGeneratorEntity.Relations.ComponentInspectionReportGeneratorEntityUsingActionToBeTakenOnGeneratorId, "ActionToBeTakenOnGeneratorEntity__", "ComponentInspectionReportGenerator_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<BooleanAnswerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BooleanAnswerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.BooleanAnswerEntity, 0, null, null, relations, null, "BooleanAnswerCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ComponentInspectionReportEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportEntity, 0, null, null, relations, null, "ComponentInspectionReportCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCouplingCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CouplingEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CouplingEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.CouplingEntity, 0, null, null, relations, null, "CouplingCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGeneratorCoverCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GeneratorCoverEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorCoverEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.GeneratorCoverEntity, 0, null, null, relations, null, "GeneratorCoverCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGeneratorDriveEndCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GeneratorDriveEndEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorDriveEndEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, 0, null, null, relations, null, "GeneratorDriveEndCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGeneratorManufacturerCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GeneratorManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.GeneratorManufacturerEntity, 0, null, null, relations, null, "GeneratorManufacturerCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGeneratorNonDriveEndCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GeneratorNonDriveEndEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorNonDriveEndEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.GeneratorNonDriveEndEntity, 0, null, null, relations, null, "GeneratorNonDriveEndCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGeneratorRotorCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GeneratorRotorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorRotorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.GeneratorRotorEntity, 0, null, null, relations, null, "GeneratorRotorCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator______
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator______", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator_____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator_____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator_______
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator_______", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator___
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator___", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator__
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathActionToBeTakenOnGenerator
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ActionToBeTakenOnGeneratorEntityFactory))),
					ActionToBeTakenOnGeneratorEntity.Relations.ActionToBeTakenOnGeneratorEntityUsingActionToBeTakenOnGeneratorIdParentActionToBeTakenOnGeneratorId, 
					(int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, 0, null, null, null, null, "ActionToBeTakenOnGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return ActionToBeTakenOnGeneratorEntity.CustomProperties;}
		}
		...
		{
			get { return ActionToBeTakenOnGeneratorEntity.FieldsCustomProperties;}
		}

		/// <summary> The ActionToBeTakenOnGeneratorId property of the Entity ActionToBeTakenOnGenerator<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ActionToBeTakenOnGenerator"."ActionToBeTakenOnGeneratorId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 ActionToBeTakenOnGeneratorId
		{
			get { return (System.Int64)GetValue((int)ActionToBeTakenOnGeneratorFieldIndex.ActionToBeTakenOnGeneratorId, true); }
			set	{ SetValue((int)ActionToBeTakenOnGeneratorFieldIndex.ActionToBeTakenOnGeneratorId, value); }
		}

		/// <summary> The Name property of the Entity ActionToBeTakenOnGenerator<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ActionToBeTakenOnGenerator"."Name"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)ActionToBeTakenOnGeneratorFieldIndex.Name, true); }
			set	{ SetValue((int)ActionToBeTakenOnGeneratorFieldIndex.Name, value); }
		}

		/// <summary> The LanguageId property of the Entity ActionToBeTakenOnGenerator<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ActionToBeTakenOnGenerator"."LanguageId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 LanguageId
		{
			get { return (System.Int64)GetValue((int)ActionToBeTakenOnGeneratorFieldIndex.LanguageId, true); }
			set	{ SetValue((int)ActionToBeTakenOnGeneratorFieldIndex.LanguageId, value); }
		}

		/// <summary> The ParentActionToBeTakenOnGeneratorId property of the Entity ActionToBeTakenOnGenerator<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ActionToBeTakenOnGenerator"."ParentActionToBeTakenOnGeneratorId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> ParentActionToBeTakenOnGeneratorId
		{
			get { return (Nullable<System.Int64>)GetValue((int)ActionToBeTakenOnGeneratorFieldIndex.ParentActionToBeTakenOnGeneratorId, false); }
			set	{ SetValue((int)ActionToBeTakenOnGeneratorFieldIndex.ParentActionToBeTakenOnGeneratorId, value); }
		}

		/// <summary> The Sort property of the Entity ActionToBeTakenOnGenerator<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ActionToBeTakenOnGenerator"."Sort"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 Sort
		{
			get { return (System.Int64)GetValue((int)ActionToBeTakenOnGeneratorFieldIndex.Sort, true); }
			set	{ SetValue((int)ActionToBeTakenOnGeneratorFieldIndex.Sort, value); }
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'ActionToBeTakenOnGeneratorEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(ActionToBeTakenOnGeneratorEntity))]
		public virtual EntityCollection<ActionToBeTakenOnGeneratorEntity> ActionToBeTakenOnGenerator_
		{
			get
			{
				if(_actionToBeTakenOnGenerator_==null)
				{
					_actionToBeTakenOnGenerator_ = new EntityCollection<ActionToBeTakenOnGeneratorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ActionToBeTakenOnGeneratorEntityFactory)));
					_actionToBeTakenOnGenerator_.SetContainingEntityInfo(this, "ActionToBeTakenOnGenerator");
				}
				return _actionToBeTakenOnGenerator_;
			}
		}
		...
		public virtual EntityCollection<ComponentInspectionReportGeneratorEntity> ComponentInspectionReportGenerator
		{
			get
			{
				if(_componentInspectionReportGenerator==null)
				{
					...
					_componentInspectionReportGenerator.SetContainingEntityInfo(this, "ActionToBeTakenOnGenerator");
				}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_actionToBeTakenOnGenerator != null)
						{
							_actionToBeTakenOnGenerator.UnsetRelatedEntity(this, "ActionToBeTakenOnGenerator_");
						}
					}
					else
					{
						((IEntity2)value).SetRelatedEntity(this, "ActionToBeTakenOnGenerator_");
					}
				}
			}
		}
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity; }
		}
		#endregion
