...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'TurbinePlacement'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class TurbinePlacementEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static TurbinePlacementEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public TurbinePlacementEntity():base("TurbinePlacementEntity")
		{
		...
		public TurbinePlacementEntity(IEntityFields2 fields):base("TurbinePlacementEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this TurbinePlacementEntity</param>
		public TurbinePlacementEntity(IValidator validator):base("TurbinePlacementEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="turbinePlacementId">PK value for TurbinePlacement which data should be fetched into this TurbinePlacement object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TurbinePlacementEntity(System.Int64 turbinePlacementId):base("TurbinePlacementEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.TurbinePlacementId = turbinePlacementId;
		}
		...
		/// <param name="validator">The custom validator object for this TurbinePlacementEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TurbinePlacementEntity(System.Int64 turbinePlacementId, IValidator validator):base("TurbinePlacementEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.TurbinePlacementId = turbinePlacementId;
		}
		...
		protected TurbinePlacementEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((TurbinePlacementFieldIndex)fieldIndex)
			{
				default:
		...
		public bool TestOriginalFieldValueForNull(TurbinePlacementFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(TurbinePlacementFieldIndex fieldIndex)
		{
		...
		{
			return new TurbinePlacementRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoTurbineMatrix()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TurbineMatrixFields.TurbinePlacementId, null, ComparisonOperator.Equal, this.TurbinePlacementId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(TurbinePlacementEntity.Relations.TurbineMatrixEntityUsingTurbinePlacementId, "TurbinePlacementEntity__", "TurbineMatrix_", JoinHint.None);
			bucket.Relations.Add(TurbineMatrixEntity.Relations.TurbineEntityUsingTurbineId, "TurbineMatrix_", string.Empty, JoinHint.None);
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TurbinePlacementFields.TurbinePlacementId, null, ComparisonOperator.Equal, this.TurbinePlacementId, "TurbinePlacementEntity__"));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(TurbinePlacementEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("Placement", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this TurbinePlacementEntity</param>
		...
		public  static TurbinePlacementRelations Relations
		{
			get	{ return new TurbinePlacementRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineMatrix
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<TurbineMatrixEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineMatrixEntityFactory))),
					TurbinePlacementEntity.Relations.TurbineMatrixEntityUsingTurbinePlacementId, 
					(int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineMatrixEntity, 0, null, null, null, null, "TurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineCollectionViaTurbineMatrix
		{
			get
			{
				...
				IEntityRelation intermediateRelation = TurbinePlacementEntity.Relations.TurbineMatrixEntityUsingTurbinePlacementId;
				intermediateRelation.SetAliases(string.Empty, "TurbineMatrix_");
				relations.Add(TurbinePlacementEntity.Relations.TurbineMatrixEntityUsingTurbinePlacementId, "TurbinePlacementEntity__", "TurbineMatrix_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineEntity, 0, null, null, relations, null, "TurbineCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineFrequencyCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineFrequencyEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineFrequencyEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, 0, null, null, relations, null, "TurbineFrequencyCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineManufacturerCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineManufacturerEntity, 0, null, null, relations, null, "TurbineManufacturerCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineMarkVersionCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineMarkVersionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineMarkVersionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineMarkVersionEntity, 0, null, null, relations, null, "TurbineMarkVersionCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineNominelPowerCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineNominelPowerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineNominelPowerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineNominelPowerEntity, 0, null, null, relations, null, "TurbineNominelPowerCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineOldCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineOldEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineOldEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, 0, null, null, relations, null, "TurbineOldCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbinePowerRegulationCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbinePowerRegulationEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbinePowerRegulationEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, (int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, 0, null, null, relations, null, "TurbinePowerRegulationCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineRotorDiameterCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineRotorDiameterEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineRotorDiameterEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, 0, null, null, relations, null, "TurbineRotorDiameterCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineSmallGeneratorCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineSmallGeneratorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineSmallGeneratorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, 0, null, null, relations, null, "TurbineSmallGeneratorCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineTemperatureVariantCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineTemperatureVariantEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineTemperatureVariantEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, 0, null, null, relations, null, "TurbineTemperatureVariantCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineVoltageCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineVoltageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineVoltageEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineVoltageEntity, 0, null, null, relations, null, "TurbineVoltageCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return TurbinePlacementEntity.CustomProperties;}
		}
		...
		{
			get { return TurbinePlacementEntity.FieldsCustomProperties;}
		}

		/// <summary> The TurbinePlacementId property of the Entity TurbinePlacement<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbinePlacement"."TurbinePlacementId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 TurbinePlacementId
		{
			get { return (System.Int64)GetValue((int)TurbinePlacementFieldIndex.TurbinePlacementId, true); }
			set	{ SetValue((int)TurbinePlacementFieldIndex.TurbinePlacementId, value); }
		}

		/// <summary> The Placement property of the Entity TurbinePlacement<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbinePlacement"."Placement"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 20<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Placement
		{
			get { return (System.String)GetValue((int)TurbinePlacementFieldIndex.Placement, true); }
			set	{ SetValue((int)TurbinePlacementFieldIndex.Placement, value); }
		}

		/// <summary> The Created property of the Entity TurbinePlacement<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbinePlacement"."Created"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime Created
		{
			get { return (System.DateTime)GetValue((int)TurbinePlacementFieldIndex.Created, true); }
			set	{ SetValue((int)TurbinePlacementFieldIndex.Created, value); }
		}

		/// <summary> The CreatedBy property of the Entity TurbinePlacement<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbinePlacement"."CreatedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String CreatedBy
		{
			get { return (System.String)GetValue((int)TurbinePlacementFieldIndex.CreatedBy, true); }
			set	{ SetValue((int)TurbinePlacementFieldIndex.CreatedBy, value); }
		}

		/// <summary> The Deleted property of the Entity TurbinePlacement<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbinePlacement"."Deleted"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> Deleted
		{
			get { return (Nullable<System.DateTime>)GetValue((int)TurbinePlacementFieldIndex.Deleted, false); }
			set	{ SetValue((int)TurbinePlacementFieldIndex.Deleted, value); }
		}

		/// <summary> The DeletedBy property of the Entity TurbinePlacement<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbinePlacement"."DeletedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String DeletedBy
		{
			get { return (System.String)GetValue((int)TurbinePlacementFieldIndex.DeletedBy, true); }
			set	{ SetValue((int)TurbinePlacementFieldIndex.DeletedBy, value); }
		}
		...
		public virtual EntityCollection<TurbineMatrixEntity> TurbineMatrix
		{
			get
			{
				if(_turbineMatrix==null)
				{
					...
					_turbineMatrix.SetContainingEntityInfo(this, "TurbinePlacement");
				}
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity; }
		}
		#endregion
