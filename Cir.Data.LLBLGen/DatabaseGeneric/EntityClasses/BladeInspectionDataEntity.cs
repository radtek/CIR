...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'BladeInspectionData'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class BladeInspectionDataEntity : CommonEntityBase, ISerializable
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfaces
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private EntityCollection<BladeInspectionDataEntity> _bladeInspectionData_;
		...
		public static class MemberNames
		{
			...
			/// <summary>Member name BladeInspectionData_</summary>
			public static readonly string BladeInspectionData_ = "BladeInspectionData_";
		...
		static BladeInspectionDataEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public BladeInspectionDataEntity():base("BladeInspectionDataEntity")
		{
		...
		public BladeInspectionDataEntity(IEntityFields2 fields):base("BladeInspectionDataEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this BladeInspectionDataEntity</param>
		public BladeInspectionDataEntity(IValidator validator):base("BladeInspectionDataEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="bladeInspectionDataId">PK value for BladeInspectionData which data should be fetched into this BladeInspectionData object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public BladeInspectionDataEntity(System.Int64 bladeInspectionDataId):base("BladeInspectionDataEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.BladeInspectionDataId = bladeInspectionDataId;
		}
		...
		/// <param name="validator">The custom validator object for this BladeInspectionDataEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public BladeInspectionDataEntity(System.Int64 bladeInspectionDataId, IValidator validator):base("BladeInspectionDataEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.BladeInspectionDataId = bladeInspectionDataId;
		}
		...
		protected BladeInspectionDataEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				_bladeInspectionData_ = (EntityCollection<BladeInspectionDataEntity>)info.GetValue("_bladeInspectionData_", typeof(EntityCollection<BladeInspectionDataEntity>));
		...
		{
			switch((BladeInspectionDataFieldIndex)fieldIndex)
			{
				case BladeInspectionDataFieldIndex.ParentBladeInspectionDataId:
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				case "BladeInspectionData":
					...
					break;
				case "BladeInspectionData_":
					this.BladeInspectionData_.Add((BladeInspectionDataEntity)entity);
					break;
		...
		public override void SetRelatedEntity(IEntity2 relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				case "BladeInspectionData":
					...
					break;
				case "BladeInspectionData_":
					this.BladeInspectionData_.Add((BladeInspectionDataEntity)relatedEntity);
					OnRelatedEntitySet(relatedEntity, fieldName);
					break;
				case "ComponentInspectionReportBladeDamage":
		...
		public override void UnsetRelatedEntity(IEntity2 relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				case "BladeInspectionData":
					...
					break;
				case "BladeInspectionData_":
					base.PerformRelatedEntityRemoval(this.BladeInspectionData_, relatedEntity, signalRelatedEntityManyToOne);
					OnRelatedEntityUnset(relatedEntity, fieldName);
					break;
				case "ComponentInspectionReportBladeDamage":
		...
		public override List<IEntityCollection2> GetMemberEntityCollections()
		{
			...
			toReturn.Add(this.BladeInspectionData_);
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_bladeInspectionData_", ((_bladeInspectionData_!=null) && (_bladeInspectionData_.Count>0) && !this.MarkedForDeletion)?_bladeInspectionData_:null);
		...
		public bool TestOriginalFieldValueForNull(BladeInspectionDataFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(BladeInspectionDataFieldIndex fieldIndex)
		{
		...
		{
			return new BladeInspectionDataRelations().GetAllRelations();
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoBladeInspectionData_()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(BladeInspectionDataFields.ParentBladeInspectionDataId, null, ComparisonOperator.Equal, this.BladeInspectionDataId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentInspectionReportBladeDamageFields.BladeInspectionDataId, null, ComparisonOperator.Equal, this.BladeInspectionDataId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(BladeInspectionDataEntity.Relations.ComponentInspectionReportBladeDamageEntityUsingBladeInspectionDataId, "BladeInspectionDataEntity__", "ComponentInspectionReportBladeDamage_", JoinHint.None);
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(BladeInspectionDataFields.BladeInspectionDataId, null, ComparisonOperator.Equal, this.BladeInspectionDataId, "BladeInspectionDataEntity__"));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(BladeInspectionDataFields.BladeInspectionDataId, null, ComparisonOperator.Equal, this.ParentBladeInspectionDataId));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.BladeInspectionDataEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(BladeInspectionDataEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._bladeInspectionData_);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._bladeInspectionData_ = (EntityCollection<BladeInspectionDataEntity>) collectionsQueue.Dequeue();
		...
		{
			if (this._bladeInspectionData_ != null)
			{
				return true;
			}
		...
		public override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("BladeInspectionData_", _bladeInspectionData_);
		...
		{
			if(_bladeInspectionData_!=null)
			{
				_bladeInspectionData_.ActiveContext = base.ActiveContext;
			}
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ParentBladeInspectionDataId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			base.PerformDesetupSyncRelatedEntity( _bladeInspectionData, new PropertyChangedEventHandler( OnBladeInspectionDataPropertyChanged ), "BladeInspectionData", BladeInspectionDataEntity.Relations.BladeInspectionDataEntityUsingBladeInspectionDataIdParentBladeInspectionDataId, true, signalRelatedEntity, "BladeInspectionData_", resetFKFields, new int[] { (int)BladeInspectionDataFieldIndex.ParentBladeInspectionDataId } );		
			_bladeInspectionData = null;
		}
		...
		private void SetupSyncBladeInspectionData(IEntity2 relatedEntity)
		{
			...
			base.PerformSetupSyncRelatedEntity( _bladeInspectionData, new PropertyChangedEventHandler( OnBladeInspectionDataPropertyChanged ), "BladeInspectionData", BladeInspectionDataEntity.Relations.BladeInspectionDataEntityUsingBladeInspectionDataIdParentBladeInspectionDataId, true, new string[] {  } );
		}
		...
		/// <param name="validator">The validator object for this BladeInspectionDataEntity</param>
		...
		public  static BladeInspectionDataRelations Relations
		{
			get	{ return new BladeInspectionDataRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBladeInspectionData_
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<BladeInspectionDataEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BladeInspectionDataEntityFactory))),
					BladeInspectionDataEntity.Relations.BladeInspectionDataEntityUsingParentBladeInspectionDataId, 
					(int)Cir.Data.LLBLGen.EntityType.BladeInspectionDataEntity, (int)Cir.Data.LLBLGen.EntityType.BladeInspectionDataEntity, 0, null, null, null, null, "BladeInspectionData_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportBladeDamage
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ComponentInspectionReportBladeDamageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportBladeDamageEntityFactory))),
					BladeInspectionDataEntity.Relations.ComponentInspectionReportBladeDamageEntityUsingBladeInspectionDataId, 
					(int)Cir.Data.LLBLGen.EntityType.BladeInspectionDataEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportBladeDamageEntity, 0, null, null, null, null, "ComponentInspectionReportBladeDamage", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBladeDamagePlacementCollectionViaComponentInspectionReportBladeDamage
		{
			get
			{
				...
				IEntityRelation intermediateRelation = BladeInspectionDataEntity.Relations.ComponentInspectionReportBladeDamageEntityUsingBladeInspectionDataId;
				intermediateRelation.SetAliases(string.Empty, "ComponentInspectionReportBladeDamage_");
				relations.Add(BladeInspectionDataEntity.Relations.ComponentInspectionReportBladeDamageEntityUsingBladeInspectionDataId, "BladeInspectionDataEntity__", "ComponentInspectionReportBladeDamage_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<BladeDamagePlacementEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BladeDamagePlacementEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.BladeInspectionDataEntity, (int)Cir.Data.LLBLGen.EntityType.BladeDamagePlacementEntity, 0, null, null, relations, null, "BladeDamagePlacementCollectionViaComponentInspectionReportBladeDamage", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBladeEdgeCollectionViaComponentInspectionReportBladeDamage
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BladeEdgeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BladeEdgeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.BladeInspectionDataEntity, (int)Cir.Data.LLBLGen.EntityType.BladeEdgeEntity, 0, null, null, relations, null, "BladeEdgeCollectionViaComponentInspectionReportBladeDamage", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportBladeCollectionViaComponentInspectionReportBladeDamage
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ComponentInspectionReportBladeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportBladeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.BladeInspectionDataEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportBladeEntity, 0, null, null, relations, null, "ComponentInspectionReportBladeCollectionViaComponentInspectionReportBladeDamage", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBladeInspectionData
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(BladeInspectionDataEntityFactory))),
					BladeInspectionDataEntity.Relations.BladeInspectionDataEntityUsingBladeInspectionDataIdParentBladeInspectionDataId, 
					(int)Cir.Data.LLBLGen.EntityType.BladeInspectionDataEntity, (int)Cir.Data.LLBLGen.EntityType.BladeInspectionDataEntity, 0, null, null, null, null, "BladeInspectionData", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return BladeInspectionDataEntity.CustomProperties;}
		}
		...
		{
			get { return BladeInspectionDataEntity.FieldsCustomProperties;}
		}

		/// <summary> The BladeInspectionDataId property of the Entity BladeInspectionData<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BladeInspectionData"."BladeInspectionDataId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 BladeInspectionDataId
		{
			get { return (System.Int64)GetValue((int)BladeInspectionDataFieldIndex.BladeInspectionDataId, true); }
			set	{ SetValue((int)BladeInspectionDataFieldIndex.BladeInspectionDataId, value); }
		}

		/// <summary> The Name property of the Entity BladeInspectionData<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BladeInspectionData"."Name"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)BladeInspectionDataFieldIndex.Name, true); }
			set	{ SetValue((int)BladeInspectionDataFieldIndex.Name, value); }
		}

		/// <summary> The LanguageId property of the Entity BladeInspectionData<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BladeInspectionData"."LanguageId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 LanguageId
		{
			get { return (System.Int64)GetValue((int)BladeInspectionDataFieldIndex.LanguageId, true); }
			set	{ SetValue((int)BladeInspectionDataFieldIndex.LanguageId, value); }
		}

		/// <summary> The ParentBladeInspectionDataId property of the Entity BladeInspectionData<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BladeInspectionData"."ParentBladeInspectionDataId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> ParentBladeInspectionDataId
		{
			get { return (Nullable<System.Int64>)GetValue((int)BladeInspectionDataFieldIndex.ParentBladeInspectionDataId, false); }
			set	{ SetValue((int)BladeInspectionDataFieldIndex.ParentBladeInspectionDataId, value); }
		}

		/// <summary> The Sort property of the Entity BladeInspectionData<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BladeInspectionData"."Sort"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 Sort
		{
			get { return (System.Int64)GetValue((int)BladeInspectionDataFieldIndex.Sort, true); }
			set	{ SetValue((int)BladeInspectionDataFieldIndex.Sort, value); }
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'BladeInspectionDataEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(BladeInspectionDataEntity))]
		public virtual EntityCollection<BladeInspectionDataEntity> BladeInspectionData_
		{
			get
			{
				if(_bladeInspectionData_==null)
				{
					_bladeInspectionData_ = new EntityCollection<BladeInspectionDataEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BladeInspectionDataEntityFactory)));
					_bladeInspectionData_.SetContainingEntityInfo(this, "BladeInspectionData");
				}
				return _bladeInspectionData_;
			}
		}
		...
		public virtual EntityCollection<ComponentInspectionReportBladeDamageEntity> ComponentInspectionReportBladeDamage
		{
			get
			{
				if(_componentInspectionReportBladeDamage==null)
				{
					...
					_componentInspectionReportBladeDamage.SetContainingEntityInfo(this, "BladeInspectionData");
				}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_bladeInspectionData != null)
						{
							_bladeInspectionData.UnsetRelatedEntity(this, "BladeInspectionData_");
						}
					}
					else
					{
						((IEntity2)value).SetRelatedEntity(this, "BladeInspectionData_");
					}
				}
			}
		}
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.BladeInspectionDataEntity; }
		}
		#endregion
