...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'TurbinePowerRegulation'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class TurbinePowerRegulationEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static TurbinePowerRegulationEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public TurbinePowerRegulationEntity():base("TurbinePowerRegulationEntity")
		{
		...
		public TurbinePowerRegulationEntity(IEntityFields2 fields):base("TurbinePowerRegulationEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this TurbinePowerRegulationEntity</param>
		public TurbinePowerRegulationEntity(IValidator validator):base("TurbinePowerRegulationEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="turbinePowerRegulationId">PK value for TurbinePowerRegulation which data should be fetched into this TurbinePowerRegulation object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TurbinePowerRegulationEntity(System.Int64 turbinePowerRegulationId):base("TurbinePowerRegulationEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.TurbinePowerRegulationId = turbinePowerRegulationId;
		}
		...
		/// <param name="validator">The custom validator object for this TurbinePowerRegulationEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TurbinePowerRegulationEntity(System.Int64 turbinePowerRegulationId, IValidator validator):base("TurbinePowerRegulationEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.TurbinePowerRegulationId = turbinePowerRegulationId;
		}
		...
		protected TurbinePowerRegulationEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((TurbinePowerRegulationFieldIndex)fieldIndex)
			{
				default:
		...
		public bool TestOriginalFieldValueForNull(TurbinePowerRegulationFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(TurbinePowerRegulationFieldIndex fieldIndex)
		{
		...
		{
			return new TurbinePowerRegulationRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoTurbineMatrix()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TurbineMatrixFields.TurbinePowerRegulationId, null, ComparisonOperator.Equal, this.TurbinePowerRegulationId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(TurbinePowerRegulationEntity.Relations.TurbineMatrixEntityUsingTurbinePowerRegulationId, "TurbinePowerRegulationEntity__", "TurbineMatrix_", JoinHint.None);
			bucket.Relations.Add(TurbineMatrixEntity.Relations.TurbineEntityUsingTurbineId, "TurbineMatrix_", string.Empty, JoinHint.None);
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TurbinePowerRegulationFields.TurbinePowerRegulationId, null, ComparisonOperator.Equal, this.TurbinePowerRegulationId, "TurbinePowerRegulationEntity__"));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(TurbinePowerRegulationEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this TurbinePowerRegulationEntity</param>
		...
		public  static TurbinePowerRegulationRelations Relations
		{
			get	{ return new TurbinePowerRegulationRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineMatrix
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<TurbineMatrixEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineMatrixEntityFactory))),
					TurbinePowerRegulationEntity.Relations.TurbineMatrixEntityUsingTurbinePowerRegulationId, 
					(int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineMatrixEntity, 0, null, null, null, null, "TurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineCollectionViaTurbineMatrix
		{
			get
			{
				...
				IEntityRelation intermediateRelation = TurbinePowerRegulationEntity.Relations.TurbineMatrixEntityUsingTurbinePowerRegulationId;
				intermediateRelation.SetAliases(string.Empty, "TurbineMatrix_");
				relations.Add(TurbinePowerRegulationEntity.Relations.TurbineMatrixEntityUsingTurbinePowerRegulationId, "TurbinePowerRegulationEntity__", "TurbineMatrix_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineEntity, 0, null, null, relations, null, "TurbineCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineFrequencyCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineFrequencyEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineFrequencyEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, 0, null, null, relations, null, "TurbineFrequencyCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineManufacturerCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineManufacturerEntity, 0, null, null, relations, null, "TurbineManufacturerCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineMarkVersionCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineMarkVersionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineMarkVersionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineMarkVersionEntity, 0, null, null, relations, null, "TurbineMarkVersionCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineNominelPowerCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineNominelPowerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineNominelPowerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineNominelPowerEntity, 0, null, null, relations, null, "TurbineNominelPowerCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineOldCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineOldEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineOldEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, 0, null, null, relations, null, "TurbineOldCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbinePlacementCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbinePlacementEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbinePlacementEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, (int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, 0, null, null, relations, null, "TurbinePlacementCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineRotorDiameterCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineRotorDiameterEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineRotorDiameterEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, 0, null, null, relations, null, "TurbineRotorDiameterCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineSmallGeneratorCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineSmallGeneratorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineSmallGeneratorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, 0, null, null, relations, null, "TurbineSmallGeneratorCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineTemperatureVariantCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineTemperatureVariantEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineTemperatureVariantEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, 0, null, null, relations, null, "TurbineTemperatureVariantCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineVoltageCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineVoltageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineVoltageEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineVoltageEntity, 0, null, null, relations, null, "TurbineVoltageCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return TurbinePowerRegulationEntity.CustomProperties;}
		}
		...
		{
			get { return TurbinePowerRegulationEntity.FieldsCustomProperties;}
		}

		/// <summary> The TurbinePowerRegulationId property of the Entity TurbinePowerRegulation<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbinePowerRegulation"."TurbinePowerRegulationId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 TurbinePowerRegulationId
		{
			get { return (System.Int64)GetValue((int)TurbinePowerRegulationFieldIndex.TurbinePowerRegulationId, true); }
			set	{ SetValue((int)TurbinePowerRegulationFieldIndex.TurbinePowerRegulationId, value); }
		}

		/// <summary> The PowerRegulation property of the Entity TurbinePowerRegulation<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbinePowerRegulation"."PowerRegulation"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String PowerRegulation
		{
			get { return (System.String)GetValue((int)TurbinePowerRegulationFieldIndex.PowerRegulation, true); }
			set	{ SetValue((int)TurbinePowerRegulationFieldIndex.PowerRegulation, value); }
		}

		/// <summary> The Created property of the Entity TurbinePowerRegulation<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbinePowerRegulation"."Created"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime Created
		{
			get { return (System.DateTime)GetValue((int)TurbinePowerRegulationFieldIndex.Created, true); }
			set	{ SetValue((int)TurbinePowerRegulationFieldIndex.Created, value); }
		}

		/// <summary> The CreatedBy property of the Entity TurbinePowerRegulation<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbinePowerRegulation"."CreatedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String CreatedBy
		{
			get { return (System.String)GetValue((int)TurbinePowerRegulationFieldIndex.CreatedBy, true); }
			set	{ SetValue((int)TurbinePowerRegulationFieldIndex.CreatedBy, value); }
		}

		/// <summary> The Deleted property of the Entity TurbinePowerRegulation<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbinePowerRegulation"."Deleted"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> Deleted
		{
			get { return (Nullable<System.DateTime>)GetValue((int)TurbinePowerRegulationFieldIndex.Deleted, false); }
			set	{ SetValue((int)TurbinePowerRegulationFieldIndex.Deleted, value); }
		}

		/// <summary> The DeletedBy property of the Entity TurbinePowerRegulation<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbinePowerRegulation"."DeletedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String DeletedBy
		{
			get { return (System.String)GetValue((int)TurbinePowerRegulationFieldIndex.DeletedBy, true); }
			set	{ SetValue((int)TurbinePowerRegulationFieldIndex.DeletedBy, value); }
		}
		...
		public virtual EntityCollection<TurbineMatrixEntity> TurbineMatrix
		{
			get
			{
				if(_turbineMatrix==null)
				{
					...
					_turbineMatrix.SetContainingEntityInfo(this, "TurbinePowerRegulation");
				}
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity; }
		}
		#endregion
