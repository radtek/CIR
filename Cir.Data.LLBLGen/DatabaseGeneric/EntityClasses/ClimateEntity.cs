...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'Climate'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ClimateEntity : CommonEntityBase, ISerializable
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfaces
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private EntityCollection<ClimateEntity> _climate_;
		...
		public static class MemberNames
		{
			...
			/// <summary>Member name Climate_</summary>
			public static readonly string Climate_ = "Climate_";
		...
		static ClimateEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public ClimateEntity():base("ClimateEntity")
		{
		...
		public ClimateEntity(IEntityFields2 fields):base("ClimateEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ClimateEntity</param>
		public ClimateEntity(IValidator validator):base("ClimateEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="climateId">PK value for Climate which data should be fetched into this Climate object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ClimateEntity(System.Int64 climateId):base("ClimateEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this ClimateEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ClimateEntity(System.Int64 climateId, IValidator validator):base("ClimateEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.ClimateId = climateId;
		}
		...
		protected ClimateEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				_climate_ = (EntityCollection<ClimateEntity>)info.GetValue("_climate_", typeof(EntityCollection<ClimateEntity>));
		...
		{
			switch((ClimateFieldIndex)fieldIndex)
			{
				case ClimateFieldIndex.ParentClimateId:
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				case "Climate":
					...
					break;
				case "Climate_":
					this.Climate_.Add((ClimateEntity)entity);
					break;
		...
		public override void SetRelatedEntity(IEntity2 relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				case "Climate":
					...
					break;
				case "Climate_":
					this.Climate_.Add((ClimateEntity)relatedEntity);
					OnRelatedEntitySet(relatedEntity, fieldName);
					break;
				case "ComponentInspectionReportTransformer":
		...
		public override void UnsetRelatedEntity(IEntity2 relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				case "Climate":
					...
					break;
				case "Climate_":
					base.PerformRelatedEntityRemoval(this.Climate_, relatedEntity, signalRelatedEntityManyToOne);
					OnRelatedEntityUnset(relatedEntity, fieldName);
					break;
				case "ComponentInspectionReportTransformer":
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_climate_", ((_climate_!=null) && (_climate_.Count>0) && !this.MarkedForDeletion)?_climate_:null);
		...
		public bool TestOriginalFieldValueForNull(ClimateFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ClimateFieldIndex fieldIndex)
		{
		...
		{
			return new ClimateRelations().GetAllRelations();
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoClimate_()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ClimateFields.ParentClimateId, null, ComparisonOperator.Equal, this.ClimateId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentInspectionReportTransformerFields.ClimateId, null, ComparisonOperator.Equal, this.ClimateId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(ClimateEntity.Relations.ComponentInspectionReportTransformerEntityUsingClimateId, "ClimateEntity__", "ComponentInspectionReportTransformer_", JoinHint.None);
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ClimateFields.ClimateId, null, ComparisonOperator.Equal, this.ClimateId, "ClimateEntity__"));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ClimateFields.ClimateId, null, ComparisonOperator.Equal, this.ParentClimateId));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.ClimateEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ClimateEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._climate_);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._climate_ = (EntityCollection<ClimateEntity>) collectionsQueue.Dequeue();
		...
		public override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("Climate_", _climate_);
		...
		protected override void AddInternalsToContext()
		{
			if(_climate_!=null)
			{
				_climate_.ActiveContext = base.ActiveContext;
			}
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ParentClimateId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			base.PerformDesetupSyncRelatedEntity( _climate, new PropertyChangedEventHandler( OnClimatePropertyChanged ), "Climate", ClimateEntity.Relations.ClimateEntityUsingClimateIdParentClimateId, true, signalRelatedEntity, "Climate_", resetFKFields, new int[] { (int)ClimateFieldIndex.ParentClimateId } );		
			_climate = null;
		}
		...
		private void SetupSyncClimate(IEntity2 relatedEntity)
		{
			...
			base.PerformSetupSyncRelatedEntity( _climate, new PropertyChangedEventHandler( OnClimatePropertyChanged ), "Climate", ClimateEntity.Relations.ClimateEntityUsingClimateIdParentClimateId, true, new string[] {  } );
		}
		...
		/// <param name="validator">The validator object for this ClimateEntity</param>
		...
		public  static ClimateRelations Relations
		{
			get	{ return new ClimateRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathClimate_
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ClimateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ClimateEntityFactory))),
					ClimateEntity.Relations.ClimateEntityUsingParentClimateId, 
					(int)Cir.Data.LLBLGen.EntityType.ClimateEntity, (int)Cir.Data.LLBLGen.EntityType.ClimateEntity, 0, null, null, null, null, "Climate_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportTransformer
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ComponentInspectionReportTransformerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportTransformerEntityFactory))),
					ClimateEntity.Relations.ComponentInspectionReportTransformerEntityUsingClimateId, 
					(int)Cir.Data.LLBLGen.EntityType.ClimateEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportTransformerEntity, 0, null, null, null, null, "ComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathActionOnTransformerCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				IEntityRelation intermediateRelation = ClimateEntity.Relations.ComponentInspectionReportTransformerEntityUsingClimateId;
				intermediateRelation.SetAliases(string.Empty, "ComponentInspectionReportTransformer_");
				relations.Add(ClimateEntity.Relations.ComponentInspectionReportTransformerEntityUsingClimateId, "ClimateEntity__", "ComponentInspectionReportTransformer_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<ActionOnTransformerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ActionOnTransformerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ClimateEntity, (int)Cir.Data.LLBLGen.EntityType.ActionOnTransformerEntity, 0, null, null, relations, null, "ActionOnTransformerCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathArcDetectionCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ArcDetectionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ArcDetectionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ClimateEntity, (int)Cir.Data.LLBLGen.EntityType.ArcDetectionEntity, 0, null, null, relations, null, "ArcDetectionCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBooleanAnswerCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BooleanAnswerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BooleanAnswerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ClimateEntity, (int)Cir.Data.LLBLGen.EntityType.BooleanAnswerEntity, 0, null, null, relations, null, "BooleanAnswerCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBracketsCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BracketsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BracketsEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ClimateEntity, (int)Cir.Data.LLBLGen.EntityType.BracketsEntity, 0, null, null, relations, null, "BracketsCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCableConditionCollectionViaComponentInspectionReportTransformer_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CableConditionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CableConditionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ClimateEntity, (int)Cir.Data.LLBLGen.EntityType.CableConditionEntity, 0, null, null, relations, null, "CableConditionCollectionViaComponentInspectionReportTransformer_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCableConditionCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CableConditionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CableConditionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ClimateEntity, (int)Cir.Data.LLBLGen.EntityType.CableConditionEntity, 0, null, null, relations, null, "CableConditionCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCoilConditionCollectionViaComponentInspectionReportTransformer_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CoilConditionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CoilConditionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ClimateEntity, (int)Cir.Data.LLBLGen.EntityType.CoilConditionEntity, 0, null, null, relations, null, "CoilConditionCollectionViaComponentInspectionReportTransformer_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCoilConditionCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CoilConditionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CoilConditionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ClimateEntity, (int)Cir.Data.LLBLGen.EntityType.CoilConditionEntity, 0, null, null, relations, null, "CoilConditionCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ComponentInspectionReportEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ClimateEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportEntity, 0, null, null, relations, null, "ComponentInspectionReportCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathConnectionBarsCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ConnectionBarsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ConnectionBarsEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ClimateEntity, (int)Cir.Data.LLBLGen.EntityType.ConnectionBarsEntity, 0, null, null, relations, null, "ConnectionBarsCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathSurgeArrestorCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<SurgeArrestorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SurgeArrestorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ClimateEntity, (int)Cir.Data.LLBLGen.EntityType.SurgeArrestorEntity, 0, null, null, relations, null, "SurgeArrestorCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTransformerManufacturerCollectionViaComponentInspectionReportTransformer
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TransformerManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TransformerManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.ClimateEntity, (int)Cir.Data.LLBLGen.EntityType.TransformerManufacturerEntity, 0, null, null, relations, null, "TransformerManufacturerCollectionViaComponentInspectionReportTransformer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathClimate
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ClimateEntityFactory))),
					ClimateEntity.Relations.ClimateEntityUsingClimateIdParentClimateId, 
					(int)Cir.Data.LLBLGen.EntityType.ClimateEntity, (int)Cir.Data.LLBLGen.EntityType.ClimateEntity, 0, null, null, null, null, "Climate", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return ClimateEntity.CustomProperties;}
		}
		...
		{
			get { return ClimateEntity.FieldsCustomProperties;}
		}

		/// <summary> The ClimateId property of the Entity Climate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Climate"."ClimateId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 ClimateId
		{
			get { return (System.Int64)GetValue((int)ClimateFieldIndex.ClimateId, true); }
			set	{ SetValue((int)ClimateFieldIndex.ClimateId, value); }
		}

		/// <summary> The Name property of the Entity Climate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Climate"."Name"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)ClimateFieldIndex.Name, true); }
			set	{ SetValue((int)ClimateFieldIndex.Name, value); }
		}

		/// <summary> The LanguageId property of the Entity Climate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Climate"."LanguageId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 LanguageId
		{
			get { return (System.Int64)GetValue((int)ClimateFieldIndex.LanguageId, true); }
			set	{ SetValue((int)ClimateFieldIndex.LanguageId, value); }
		}

		/// <summary> The ParentClimateId property of the Entity Climate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Climate"."ParentClimateId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> ParentClimateId
		{
			get { return (Nullable<System.Int64>)GetValue((int)ClimateFieldIndex.ParentClimateId, false); }
			set	{ SetValue((int)ClimateFieldIndex.ParentClimateId, value); }
		}

		/// <summary> The Sort property of the Entity Climate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Climate"."Sort"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 Sort
		{
			get { return (System.Int64)GetValue((int)ClimateFieldIndex.Sort, true); }
			set	{ SetValue((int)ClimateFieldIndex.Sort, value); }
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'ClimateEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(ClimateEntity))]
		public virtual EntityCollection<ClimateEntity> Climate_
		{
			get
			{
				if(_climate_==null)
				{
					_climate_ = new EntityCollection<ClimateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ClimateEntityFactory)));
					_climate_.SetContainingEntityInfo(this, "Climate");
				}
				return _climate_;
			}
		}
		...
		public virtual EntityCollection<ComponentInspectionReportTransformerEntity> ComponentInspectionReportTransformer
		{
			get
			{
				if(_componentInspectionReportTransformer==null)
				{
					...
					_componentInspectionReportTransformer.SetContainingEntityInfo(this, "Climate");
				}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_climate != null)
						{
							_climate.UnsetRelatedEntity(this, "Climate_");
						}
					}
					else
					{
						((IEntity2)value).SetRelatedEntity(this, "Climate_");
					}
				}
			}
		}
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.ClimateEntity; }
		}
		#endregion
