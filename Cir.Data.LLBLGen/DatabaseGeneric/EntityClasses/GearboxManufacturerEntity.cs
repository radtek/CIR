...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'GearboxManufacturer'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class GearboxManufacturerEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<GearboxManufacturerEntity> _gearboxManufacturer_;
		private EntityCollection<GearboxTypeEntity> _gearboxType;
		...
		private EntityCollection<GearboxTypeEntity> _gearboxTypeCollectionViaGearboxType;
		...
		public static class MemberNames
		{
			...
			/// <summary>Member name GearboxManufacturer_</summary>
			public static readonly string GearboxManufacturer_ = "GearboxManufacturer_";
			...
			/// <summary>Member name GearboxTypeCollectionViaGearboxType</summary>
			public static readonly string GearboxTypeCollectionViaGearboxType = "GearboxTypeCollectionViaGearboxType";
		...
		static GearboxManufacturerEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public GearboxManufacturerEntity():base("GearboxManufacturerEntity")
		{
		...
		public GearboxManufacturerEntity(IEntityFields2 fields):base("GearboxManufacturerEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this GearboxManufacturerEntity</param>
		public GearboxManufacturerEntity(IValidator validator):base("GearboxManufacturerEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="gearboxManufacturerId">PK value for GearboxManufacturer which data should be fetched into this GearboxManufacturer object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public GearboxManufacturerEntity(System.Int64 gearboxManufacturerId):base("GearboxManufacturerEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.GearboxManufacturerId = gearboxManufacturerId;
		}
		...
		/// <param name="validator">The custom validator object for this GearboxManufacturerEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public GearboxManufacturerEntity(System.Int64 gearboxManufacturerId, IValidator validator):base("GearboxManufacturerEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.GearboxManufacturerId = gearboxManufacturerId;
		}
		...
		protected GearboxManufacturerEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_gearboxManufacturer_ = (EntityCollection<GearboxManufacturerEntity>)info.GetValue("_gearboxManufacturer_", typeof(EntityCollection<GearboxManufacturerEntity>));
				_gearboxType = (EntityCollection<GearboxTypeEntity>)info.GetValue("_gearboxType", typeof(EntityCollection<GearboxTypeEntity>));
				...
				_gearboxTypeCollectionViaGearboxType = (EntityCollection<GearboxTypeEntity>)info.GetValue("_gearboxTypeCollectionViaGearboxType", typeof(EntityCollection<GearboxTypeEntity>));
		...
		{
			switch((GearboxManufacturerFieldIndex)fieldIndex)
			{
				case GearboxManufacturerFieldIndex.ParentGearboxManufacturerId:
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				...
				case "ComponentInspectionReportGeneral":
					...
					break;
				case "GearboxManufacturer_":
					this.GearboxManufacturer_.Add((GearboxManufacturerEntity)entity);
					break;
				case "GearboxType":
					this.GearboxType.Add((GearboxTypeEntity)entity);
					break;
				...
				case "GearboxRevisionCollectionViaComponentInspectionReportGearbox":
					...
					break;
				case "GearboxTypeCollectionViaGearboxType":
					this.GearboxTypeCollectionViaGearboxType.IsReadOnly = false;
					this.GearboxTypeCollectionViaGearboxType.Add((GearboxTypeEntity)entity);
					this.GearboxTypeCollectionViaGearboxType.IsReadOnly = true;
					break;
		...
		public override void SetRelatedEntity(IEntity2 relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				...
				case "ComponentInspectionReportGeneral":
					...
					break;
				case "GearboxManufacturer_":
					this.GearboxManufacturer_.Add((GearboxManufacturerEntity)relatedEntity);
					OnRelatedEntitySet(relatedEntity, fieldName);
					break;
				case "GearboxType":
					this.GearboxType.Add((GearboxTypeEntity)relatedEntity);
					OnRelatedEntitySet(relatedEntity, fieldName);
					break;
		...
		public override void UnsetRelatedEntity(IEntity2 relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				...
				case "ComponentInspectionReportGeneral":
					...
					break;
				case "GearboxManufacturer_":
					base.PerformRelatedEntityRemoval(this.GearboxManufacturer_, relatedEntity, signalRelatedEntityManyToOne);
					OnRelatedEntityUnset(relatedEntity, fieldName);
					break;
				case "GearboxType":
					base.PerformRelatedEntityRemoval(this.GearboxType, relatedEntity, signalRelatedEntityManyToOne);
					OnRelatedEntityUnset(relatedEntity, fieldName);
					break;
		...
		public override List<IEntityCollection2> GetMemberEntityCollections()
		{
			...
			toReturn.Add(this.GearboxManufacturer_);
			toReturn.Add(this.GearboxType);
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_gearboxManufacturer_", ((_gearboxManufacturer_!=null) && (_gearboxManufacturer_.Count>0) && !this.MarkedForDeletion)?_gearboxManufacturer_:null);
				info.AddValue("_gearboxType", ((_gearboxType!=null) && (_gearboxType.Count>0) && !this.MarkedForDeletion)?_gearboxType:null);
				...
				info.AddValue("_gearboxTypeCollectionViaGearboxType", ((_gearboxTypeCollectionViaGearboxType!=null) && (_gearboxTypeCollectionViaGearboxType.Count>0) && !this.MarkedForDeletion)?_gearboxTypeCollectionViaGearboxType:null);
		...
		public bool TestOriginalFieldValueForNull(GearboxManufacturerFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(GearboxManufacturerFieldIndex fieldIndex)
		{
		...
		{
			return new GearboxManufacturerRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoComponentInspectionReportGearbox()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentInspectionReportGearboxFields.GearboxManufacturerId, null, ComparisonOperator.Equal, this.GearboxManufacturerId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentInspectionReportGeneralFields.GeneralGearboxManufacturerId, null, ComparisonOperator.Equal, this.GearboxManufacturerId));
			return bucket;
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoGearboxManufacturer_()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(GearboxManufacturerFields.ParentGearboxManufacturerId, null, ComparisonOperator.Equal, this.GearboxManufacturerId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(GearboxTypeFields.GearboxManufacturerId, null, ComparisonOperator.Equal, this.GearboxManufacturerId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(GearboxManufacturerEntity.Relations.ComponentInspectionReportGearboxEntityUsingGearboxManufacturerId, "GearboxManufacturerEntity__", "ComponentInspectionReportGearbox_", JoinHint.None);
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(GearboxManufacturerFields.GearboxManufacturerId, null, ComparisonOperator.Equal, this.GearboxManufacturerId, "GearboxManufacturerEntity__"));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(GearboxManufacturerEntity.Relations.ComponentInspectionReportGeneralEntityUsingGeneralGearboxManufacturerId, "GearboxManufacturerEntity__", "ComponentInspectionReportGeneral_", JoinHint.None);
		...
		/// the related entities of type 'GearboxType' to this entity. Use DataAccessAdapter.FetchEntityCollection() to fetch these related entities.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoGearboxTypeCollectionViaGearboxType()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(GearboxManufacturerEntity.Relations.GearboxTypeEntityUsingGearboxManufacturerId, "GearboxManufacturerEntity__", "GearboxType_", JoinHint.None);
			bucket.Relations.Add(GearboxTypeEntity.Relations.GearboxTypeEntityUsingParentGearboxTypeId, "GearboxType_", string.Empty, JoinHint.None);
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(GearboxManufacturerFields.GearboxManufacturerId, null, ComparisonOperator.Equal, this.GearboxManufacturerId, "GearboxManufacturerEntity__"));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(GearboxManufacturerFields.GearboxManufacturerId, null, ComparisonOperator.Equal, this.ParentGearboxManufacturerId));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(GearboxManufacturerEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._gearboxManufacturer_);
			collectionsQueue.Enqueue(this._gearboxType);
			...
			collectionsQueue.Enqueue(this._gearboxTypeCollectionViaGearboxType);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._gearboxManufacturer_ = (EntityCollection<GearboxManufacturerEntity>) collectionsQueue.Dequeue();
			this._gearboxType = (EntityCollection<GearboxTypeEntity>) collectionsQueue.Dequeue();
			...
			this._gearboxTypeCollectionViaGearboxType = (EntityCollection<GearboxTypeEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			if (this._gearboxManufacturer_ != null)
			{
				return true;
			}
			if (this._gearboxType != null)
			{
				return true;
			}
			...
			if (this._gearboxTypeCollectionViaGearboxType != null)
			{
				return true;
			}
		...
		public override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("GearboxManufacturer_", _gearboxManufacturer_);
			...
			toReturn.Add("GearboxTypeCollectionViaGearboxType", _gearboxTypeCollectionViaGearboxType);
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_gearboxManufacturer_!=null)
			{
				_gearboxManufacturer_.ActiveContext = base.ActiveContext;
			}
			...
			if(_gearboxTypeCollectionViaGearboxType!=null)
			{
				_gearboxTypeCollectionViaGearboxType.ActiveContext = base.ActiveContext;
			}
		...
		protected virtual void InitClassMembers()
		{
			...
			_gearboxTypeCollectionViaGearboxType = null;
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ParentGearboxManufacturerId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			base.PerformDesetupSyncRelatedEntity( _gearboxManufacturer, new PropertyChangedEventHandler( OnGearboxManufacturerPropertyChanged ), "GearboxManufacturer", GearboxManufacturerEntity.Relations.GearboxManufacturerEntityUsingGearboxManufacturerIdParentGearboxManufacturerId, true, signalRelatedEntity, "GearboxManufacturer_", resetFKFields, new int[] { (int)GearboxManufacturerFieldIndex.ParentGearboxManufacturerId } );		
			_gearboxManufacturer = null;
		}
		...
		private void SetupSyncGearboxManufacturer(IEntity2 relatedEntity)
		{
			...
			base.PerformSetupSyncRelatedEntity( _gearboxManufacturer, new PropertyChangedEventHandler( OnGearboxManufacturerPropertyChanged ), "GearboxManufacturer", GearboxManufacturerEntity.Relations.GearboxManufacturerEntityUsingGearboxManufacturerIdParentGearboxManufacturerId, true, new string[] {  } );
		}
		...
		/// <param name="validator">The validator object for this GearboxManufacturerEntity</param>
		...
		public  static GearboxManufacturerRelations Relations
		{
			get	{ return new GearboxManufacturerRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportGearbox
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ComponentInspectionReportGearboxEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportGearboxEntityFactory))),
					GearboxManufacturerEntity.Relations.ComponentInspectionReportGearboxEntityUsingGearboxManufacturerId, 
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportGearboxEntity, 0, null, null, null, null, "ComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportGeneral
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ComponentInspectionReportGeneralEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportGeneralEntityFactory))),
					GearboxManufacturerEntity.Relations.ComponentInspectionReportGeneralEntityUsingGeneralGearboxManufacturerId, 
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportGeneralEntity, 0, null, null, null, null, "ComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		/// for this entity. Add the object returned by this property to an existing PrefetchPath2 instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathGearboxManufacturer_
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<GearboxManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearboxManufacturerEntityFactory))),
					GearboxManufacturerEntity.Relations.GearboxManufacturerEntityUsingParentGearboxManufacturerId, 
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, 0, null, null, null, null, "GearboxManufacturer_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearboxType
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<GearboxTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearboxTypeEntityFactory))),
					GearboxManufacturerEntity.Relations.GearboxTypeEntityUsingGearboxManufacturerId, 
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearboxTypeEntity, 0, null, null, null, null, "GearboxType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingErrorCollectionViaComponentInspectionReportGearbox___
		{
			get
			{
				...
				IEntityRelation intermediateRelation = GearboxManufacturerEntity.Relations.ComponentInspectionReportGearboxEntityUsingGearboxManufacturerId;
				intermediateRelation.SetAliases(string.Empty, "ComponentInspectionReportGearbox_");
				relations.Add(GearboxManufacturerEntity.Relations.ComponentInspectionReportGearboxEntityUsingGearboxManufacturerId, "GearboxManufacturerEntity__", "ComponentInspectionReportGearbox_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<BearingErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingErrorEntity, 0, null, null, relations, null, "BearingErrorCollectionViaComponentInspectionReportGearbox___", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingErrorCollectionViaComponentInspectionReportGearbox____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingErrorEntity, 0, null, null, relations, null, "BearingErrorCollectionViaComponentInspectionReportGearbox____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingErrorCollectionViaComponentInspectionReportGearbox_____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingErrorEntity, 0, null, null, relations, null, "BearingErrorCollectionViaComponentInspectionReportGearbox_____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingErrorCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingErrorEntity, 0, null, null, relations, null, "BearingErrorCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingErrorCollectionViaComponentInspectionReportGearbox_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingErrorEntity, 0, null, null, relations, null, "BearingErrorCollectionViaComponentInspectionReportGearbox_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingErrorCollectionViaComponentInspectionReportGearbox__
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingErrorEntity, 0, null, null, relations, null, "BearingErrorCollectionViaComponentInspectionReportGearbox__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingPosCollectionViaComponentInspectionReportGearbox____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingPosEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingPosEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingPosEntity, 0, null, null, relations, null, "BearingPosCollectionViaComponentInspectionReportGearbox____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingPosCollectionViaComponentInspectionReportGearbox_____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingPosEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingPosEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingPosEntity, 0, null, null, relations, null, "BearingPosCollectionViaComponentInspectionReportGearbox_____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingPosCollectionViaComponentInspectionReportGearbox___
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingPosEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingPosEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingPosEntity, 0, null, null, relations, null, "BearingPosCollectionViaComponentInspectionReportGearbox___", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingPosCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingPosEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingPosEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingPosEntity, 0, null, null, relations, null, "BearingPosCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingPosCollectionViaComponentInspectionReportGearbox_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingPosEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingPosEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingPosEntity, 0, null, null, relations, null, "BearingPosCollectionViaComponentInspectionReportGearbox_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingPosCollectionViaComponentInspectionReportGearbox__
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingPosEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingPosEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingPosEntity, 0, null, null, relations, null, "BearingPosCollectionViaComponentInspectionReportGearbox__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingTypeCollectionViaComponentInspectionReportGearbox____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingTypeEntity, 0, null, null, relations, null, "BearingTypeCollectionViaComponentInspectionReportGearbox____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingTypeCollectionViaComponentInspectionReportGearbox_____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingTypeEntity, 0, null, null, relations, null, "BearingTypeCollectionViaComponentInspectionReportGearbox_____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingTypeCollectionViaComponentInspectionReportGearbox__
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingTypeEntity, 0, null, null, relations, null, "BearingTypeCollectionViaComponentInspectionReportGearbox__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingTypeCollectionViaComponentInspectionReportGearbox_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingTypeEntity, 0, null, null, relations, null, "BearingTypeCollectionViaComponentInspectionReportGearbox_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingTypeCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingTypeEntity, 0, null, null, relations, null, "BearingTypeCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBearingTypeCollectionViaComponentInspectionReportGearbox___
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BearingTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BearingTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BearingTypeEntity, 0, null, null, relations, null, "BearingTypeCollectionViaComponentInspectionReportGearbox___", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBooleanAnswerCollectionViaComponentInspectionReportGeneral_
		{
			...
			{
				IRelationCollection relations = new RelationCollection();
				IEntityRelation intermediateRelation = GearboxManufacturerEntity.Relations.ComponentInspectionReportGeneralEntityUsingGeneralGearboxManufacturerId;
				intermediateRelation.SetAliases(string.Empty, "ComponentInspectionReportGeneral_");
				relations.Add(GearboxManufacturerEntity.Relations.ComponentInspectionReportGeneralEntityUsingGeneralGearboxManufacturerId, "GearboxManufacturerEntity__", "ComponentInspectionReportGeneral_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<BooleanAnswerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BooleanAnswerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BooleanAnswerEntity, 0, null, null, relations, null, "BooleanAnswerCollectionViaComponentInspectionReportGeneral_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBooleanAnswerCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BooleanAnswerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BooleanAnswerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BooleanAnswerEntity, 0, null, null, relations, null, "BooleanAnswerCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBooleanAnswerCollectionViaComponentInspectionReportGearbox_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BooleanAnswerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BooleanAnswerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BooleanAnswerEntity, 0, null, null, relations, null, "BooleanAnswerCollectionViaComponentInspectionReportGearbox_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBooleanAnswerCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BooleanAnswerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BooleanAnswerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.BooleanAnswerEntity, 0, null, null, relations, null, "BooleanAnswerCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentGroupCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ComponentGroupEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentGroupEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentGroupEntity, 0, null, null, relations, null, "ComponentGroupCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ComponentInspectionReportEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportEntity, 0, null, null, relations, null, "ComponentInspectionReportCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ComponentInspectionReportEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportEntity, 0, null, null, relations, null, "ComponentInspectionReportCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathControllerTypeCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ControllerTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ControllerTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ControllerTypeEntity, 0, null, null, relations, null, "ControllerTypeCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCouplingCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CouplingEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CouplingEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.CouplingEntity, 0, null, null, relations, null, "CouplingCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox_______
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox_______", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox___________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox___________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox__________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox__________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox_________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox_________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox______
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox______", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox___
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox___", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox_____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox_____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox__
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox___________________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox___________________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox__________________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox__________________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox____________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox____________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox____________________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox____________________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox_________________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox_________________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox______________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox______________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox_____________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox_____________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox________________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox________________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDamageDecisionCollectionViaComponentInspectionReportGearbox_______________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DamageDecisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DamageDecisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DamageDecisionEntity, 0, null, null, relations, null, "DamageDecisionCollectionViaComponentInspectionReportGearbox_______________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDebrisGearboxCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DebrisGearboxEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DebrisGearboxEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DebrisGearboxEntity, 0, null, null, relations, null, "DebrisGearboxCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDebrisOnMagnetCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DebrisOnMagnetEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DebrisOnMagnetEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.DebrisOnMagnetEntity, 0, null, null, relations, null, "DebrisOnMagnetCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathElectricalPumpCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ElectricalPumpEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ElectricalPumpEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ElectricalPumpEntity, 0, null, null, relations, null, "ElectricalPumpCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFilterBlockTypeCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<FilterBlockTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FilterBlockTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.FilterBlockTypeEntity, 0, null, null, relations, null, "FilterBlockTypeCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearboxRevisionCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearboxRevisionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearboxRevisionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearboxRevisionEntity, 0, null, null, relations, null, "GearboxRevisionCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// for this entity. Add the object returned by this property to an existing PrefetchPath2 instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathGearboxTypeCollectionViaGearboxType
		{
			get
			{
				IRelationCollection relations = new RelationCollection();
				IEntityRelation intermediateRelation = GearboxManufacturerEntity.Relations.GearboxTypeEntityUsingGearboxManufacturerId;
				intermediateRelation.SetAliases(string.Empty, "GearboxType_");
				relations.Add(GearboxManufacturerEntity.Relations.GearboxTypeEntityUsingGearboxManufacturerId, "GearboxManufacturerEntity__", "GearboxType_", JoinHint.None);
				relations.Add(GearboxTypeEntity.Relations.GearboxTypeEntityUsingParentGearboxTypeId, "GearboxType_", string.Empty, JoinHint.None);
				return new PrefetchPathElement2(new EntityCollection<GearboxTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearboxTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearboxTypeEntity, 0, null, null, relations, null, "GearboxTypeCollectionViaGearboxType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearboxTypeCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearboxTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearboxTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearboxTypeEntity, 0, null, null, relations, null, "GearboxTypeCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearErrorCollectionViaComponentInspectionReportGearbox_______
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearErrorEntity, 0, null, null, relations, null, "GearErrorCollectionViaComponentInspectionReportGearbox_______", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearErrorCollectionViaComponentInspectionReportGearbox_________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearErrorEntity, 0, null, null, relations, null, "GearErrorCollectionViaComponentInspectionReportGearbox_________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearErrorCollectionViaComponentInspectionReportGearbox________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearErrorEntity, 0, null, null, relations, null, "GearErrorCollectionViaComponentInspectionReportGearbox________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearErrorCollectionViaComponentInspectionReportGearbox______
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearErrorEntity, 0, null, null, relations, null, "GearErrorCollectionViaComponentInspectionReportGearbox______", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearErrorCollectionViaComponentInspectionReportGearbox____________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearErrorEntity, 0, null, null, relations, null, "GearErrorCollectionViaComponentInspectionReportGearbox____________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearErrorCollectionViaComponentInspectionReportGearbox____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearErrorEntity, 0, null, null, relations, null, "GearErrorCollectionViaComponentInspectionReportGearbox____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearErrorCollectionViaComponentInspectionReportGearbox_____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearErrorEntity, 0, null, null, relations, null, "GearErrorCollectionViaComponentInspectionReportGearbox_____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearErrorCollectionViaComponentInspectionReportGearbox_____________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearErrorEntity, 0, null, null, relations, null, "GearErrorCollectionViaComponentInspectionReportGearbox_____________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearErrorCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearErrorEntity, 0, null, null, relations, null, "GearErrorCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearErrorCollectionViaComponentInspectionReportGearbox__________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearErrorEntity, 0, null, null, relations, null, "GearErrorCollectionViaComponentInspectionReportGearbox__________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearErrorCollectionViaComponentInspectionReportGearbox___________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearErrorEntity, 0, null, null, relations, null, "GearErrorCollectionViaComponentInspectionReportGearbox___________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearErrorCollectionViaComponentInspectionReportGearbox_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearErrorEntity, 0, null, null, relations, null, "GearErrorCollectionViaComponentInspectionReportGearbox_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearErrorCollectionViaComponentInspectionReportGearbox______________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearErrorEntity, 0, null, null, relations, null, "GearErrorCollectionViaComponentInspectionReportGearbox______________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearErrorCollectionViaComponentInspectionReportGearbox___
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearErrorEntity, 0, null, null, relations, null, "GearErrorCollectionViaComponentInspectionReportGearbox___", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearErrorCollectionViaComponentInspectionReportGearbox__
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearErrorEntity, 0, null, null, relations, null, "GearErrorCollectionViaComponentInspectionReportGearbox__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearTypeCollectionViaComponentInspectionReportGearbox____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearTypeEntity, 0, null, null, relations, null, "GearTypeCollectionViaComponentInspectionReportGearbox____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearTypeCollectionViaComponentInspectionReportGearbox_____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearTypeEntity, 0, null, null, relations, null, "GearTypeCollectionViaComponentInspectionReportGearbox_____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearTypeCollectionViaComponentInspectionReportGearbox______________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearTypeEntity, 0, null, null, relations, null, "GearTypeCollectionViaComponentInspectionReportGearbox______________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearTypeCollectionViaComponentInspectionReportGearbox_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearTypeEntity, 0, null, null, relations, null, "GearTypeCollectionViaComponentInspectionReportGearbox_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearTypeCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearTypeEntity, 0, null, null, relations, null, "GearTypeCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearTypeCollectionViaComponentInspectionReportGearbox___
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearTypeEntity, 0, null, null, relations, null, "GearTypeCollectionViaComponentInspectionReportGearbox___", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearTypeCollectionViaComponentInspectionReportGearbox__
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearTypeEntity, 0, null, null, relations, null, "GearTypeCollectionViaComponentInspectionReportGearbox__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearTypeCollectionViaComponentInspectionReportGearbox_____________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearTypeEntity, 0, null, null, relations, null, "GearTypeCollectionViaComponentInspectionReportGearbox_____________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearTypeCollectionViaComponentInspectionReportGearbox_________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearTypeEntity, 0, null, null, relations, null, "GearTypeCollectionViaComponentInspectionReportGearbox_________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearTypeCollectionViaComponentInspectionReportGearbox__________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearTypeEntity, 0, null, null, relations, null, "GearTypeCollectionViaComponentInspectionReportGearbox__________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearTypeCollectionViaComponentInspectionReportGearbox________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearTypeEntity, 0, null, null, relations, null, "GearTypeCollectionViaComponentInspectionReportGearbox________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearTypeCollectionViaComponentInspectionReportGearbox______
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearTypeEntity, 0, null, null, relations, null, "GearTypeCollectionViaComponentInspectionReportGearbox______", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearTypeCollectionViaComponentInspectionReportGearbox_______
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearTypeEntity, 0, null, null, relations, null, "GearTypeCollectionViaComponentInspectionReportGearbox_______", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearTypeCollectionViaComponentInspectionReportGearbox___________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearTypeEntity, 0, null, null, relations, null, "GearTypeCollectionViaComponentInspectionReportGearbox___________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearTypeCollectionViaComponentInspectionReportGearbox____________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GearTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearTypeEntity, 0, null, null, relations, null, "GearTypeCollectionViaComponentInspectionReportGearbox____________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGeneratorManufacturerCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GeneratorManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GeneratorManufacturerEntity, 0, null, null, relations, null, "GeneratorManufacturerCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGeneratorManufacturerCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GeneratorManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GeneratorManufacturerEntity, 0, null, null, relations, null, "GeneratorManufacturerCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGeneratorManufacturerCollectionViaComponentInspectionReportGearbox_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GeneratorManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GeneratorManufacturerEntity, 0, null, null, relations, null, "GeneratorManufacturerCollectionViaComponentInspectionReportGearbox_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathHousingErrorCollectionViaComponentInspectionReportGearbox_____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<HousingErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(HousingErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.HousingErrorEntity, 0, null, null, relations, null, "HousingErrorCollectionViaComponentInspectionReportGearbox_____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathHousingErrorCollectionViaComponentInspectionReportGearbox_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<HousingErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(HousingErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.HousingErrorEntity, 0, null, null, relations, null, "HousingErrorCollectionViaComponentInspectionReportGearbox_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathHousingErrorCollectionViaComponentInspectionReportGearbox__
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<HousingErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(HousingErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.HousingErrorEntity, 0, null, null, relations, null, "HousingErrorCollectionViaComponentInspectionReportGearbox__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathHousingErrorCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<HousingErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(HousingErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.HousingErrorEntity, 0, null, null, relations, null, "HousingErrorCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathHousingErrorCollectionViaComponentInspectionReportGearbox____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<HousingErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(HousingErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.HousingErrorEntity, 0, null, null, relations, null, "HousingErrorCollectionViaComponentInspectionReportGearbox____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathHousingErrorCollectionViaComponentInspectionReportGearbox___
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<HousingErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(HousingErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.HousingErrorEntity, 0, null, null, relations, null, "HousingErrorCollectionViaComponentInspectionReportGearbox___", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathInlineFilterCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<InlineFilterEntity>(EntityFactoryCache2.GetEntityFactory(typeof(InlineFilterEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.InlineFilterEntity, 0, null, null, relations, null, "InlineFilterCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathMagnetPosCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<MagnetPosEntity>(EntityFactoryCache2.GetEntityFactory(typeof(MagnetPosEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.MagnetPosEntity, 0, null, null, relations, null, "MagnetPosCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathMechanicalOilPumpCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<MechanicalOilPumpEntity>(EntityFactoryCache2.GetEntityFactory(typeof(MechanicalOilPumpEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.MechanicalOilPumpEntity, 0, null, null, relations, null, "MechanicalOilPumpCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathNoiseCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<NoiseEntity>(EntityFactoryCache2.GetEntityFactory(typeof(NoiseEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.NoiseEntity, 0, null, null, relations, null, "NoiseCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOilLevelCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OilLevelEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OilLevelEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.OilLevelEntity, 0, null, null, relations, null, "OilLevelCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOilTypeCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OilTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OilTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.OilTypeEntity, 0, null, null, relations, null, "OilTypeCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOverallGearboxConditionCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OverallGearboxConditionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OverallGearboxConditionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.OverallGearboxConditionEntity, 0, null, null, relations, null, "OverallGearboxConditionCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShaftErrorCollectionViaComponentInspectionReportGearbox_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ShaftErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ShaftErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ShaftErrorEntity, 0, null, null, relations, null, "ShaftErrorCollectionViaComponentInspectionReportGearbox_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShaftErrorCollectionViaComponentInspectionReportGearbox___
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ShaftErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ShaftErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ShaftErrorEntity, 0, null, null, relations, null, "ShaftErrorCollectionViaComponentInspectionReportGearbox___", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShaftErrorCollectionViaComponentInspectionReportGearbox__
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ShaftErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ShaftErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ShaftErrorEntity, 0, null, null, relations, null, "ShaftErrorCollectionViaComponentInspectionReportGearbox__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShaftErrorCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ShaftErrorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ShaftErrorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ShaftErrorEntity, 0, null, null, relations, null, "ShaftErrorCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShaftTypeCollectionViaComponentInspectionReportGearbox_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ShaftTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ShaftTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ShaftTypeEntity, 0, null, null, relations, null, "ShaftTypeCollectionViaComponentInspectionReportGearbox_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShaftTypeCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ShaftTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ShaftTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ShaftTypeEntity, 0, null, null, relations, null, "ShaftTypeCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShaftTypeCollectionViaComponentInspectionReportGearbox___
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ShaftTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ShaftTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ShaftTypeEntity, 0, null, null, relations, null, "ShaftTypeCollectionViaComponentInspectionReportGearbox___", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShaftTypeCollectionViaComponentInspectionReportGearbox__
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ShaftTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ShaftTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ShaftTypeEntity, 0, null, null, relations, null, "ShaftTypeCollectionViaComponentInspectionReportGearbox__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShrinkElementCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ShrinkElementEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ShrinkElementEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.ShrinkElementEntity, 0, null, null, relations, null, "ShrinkElementCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTowerHeightCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TowerHeightEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TowerHeightEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.TowerHeightEntity, 0, null, null, relations, null, "TowerHeightCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTowerTypeCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TowerTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TowerTypeEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.TowerTypeEntity, 0, null, null, relations, null, "TowerTypeCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTransformerManufacturerCollectionViaComponentInspectionReportGeneral
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TransformerManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TransformerManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.TransformerManufacturerEntity, 0, null, null, relations, null, "TransformerManufacturerCollectionViaComponentInspectionReportGeneral", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathVibrationsCollectionViaComponentInspectionReportGearbox
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<VibrationsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(VibrationsEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.VibrationsEntity, 0, null, null, relations, null, "VibrationsCollectionViaComponentInspectionReportGearbox", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGearboxManufacturer
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(GearboxManufacturerEntityFactory))),
					GearboxManufacturerEntity.Relations.GearboxManufacturerEntityUsingGearboxManufacturerIdParentGearboxManufacturerId, 
					(int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, (int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity, 0, null, null, null, null, "GearboxManufacturer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return GearboxManufacturerEntity.CustomProperties;}
		}
		...
		{
			get { return GearboxManufacturerEntity.FieldsCustomProperties;}
		}

		/// <summary> The GearboxManufacturerId property of the Entity GearboxManufacturer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "GearboxManufacturer"."GearboxManufacturerId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 GearboxManufacturerId
		{
			get { return (System.Int64)GetValue((int)GearboxManufacturerFieldIndex.GearboxManufacturerId, true); }
			set	{ SetValue((int)GearboxManufacturerFieldIndex.GearboxManufacturerId, value); }
		}

		/// <summary> The Name property of the Entity GearboxManufacturer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "GearboxManufacturer"."Name"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)GearboxManufacturerFieldIndex.Name, true); }
			set	{ SetValue((int)GearboxManufacturerFieldIndex.Name, value); }
		}

		/// <summary> The LanguageId property of the Entity GearboxManufacturer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "GearboxManufacturer"."LanguageId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 LanguageId
		{
			get { return (System.Int64)GetValue((int)GearboxManufacturerFieldIndex.LanguageId, true); }
			set	{ SetValue((int)GearboxManufacturerFieldIndex.LanguageId, value); }
		}

		/// <summary> The ParentGearboxManufacturerId property of the Entity GearboxManufacturer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "GearboxManufacturer"."ParentGearboxManufacturerId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> ParentGearboxManufacturerId
		{
			get { return (Nullable<System.Int64>)GetValue((int)GearboxManufacturerFieldIndex.ParentGearboxManufacturerId, false); }
			set	{ SetValue((int)GearboxManufacturerFieldIndex.ParentGearboxManufacturerId, value); }
		}

		/// <summary> The Sort property of the Entity GearboxManufacturer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "GearboxManufacturer"."Sort"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 Sort
		{
			get { return (System.Int64)GetValue((int)GearboxManufacturerFieldIndex.Sort, true); }
			set	{ SetValue((int)GearboxManufacturerFieldIndex.Sort, value); }
		}

		/// <summary> The Email property of the Entity GearboxManufacturer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "GearboxManufacturer"."Email"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Email
		{
			get { return (System.String)GetValue((int)GearboxManufacturerFieldIndex.Email, true); }
			set	{ SetValue((int)GearboxManufacturerFieldIndex.Email, value); }
		}

		/// <summary> The Cc property of the Entity GearboxManufacturer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "GearboxManufacturer"."Cc"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 1000<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Cc
		{
			get { return (System.String)GetValue((int)GearboxManufacturerFieldIndex.Cc, true); }
			set	{ SetValue((int)GearboxManufacturerFieldIndex.Cc, value); }
		}

		/// <summary> The EmailContactName property of the Entity GearboxManufacturer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "GearboxManufacturer"."EmailContactName"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 200<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String EmailContactName
		{
			get { return (System.String)GetValue((int)GearboxManufacturerFieldIndex.EmailContactName, true); }
			set	{ SetValue((int)GearboxManufacturerFieldIndex.EmailContactName, value); }
		}
		...
		public virtual EntityCollection<ComponentInspectionReportGearboxEntity> ComponentInspectionReportGearbox
		{
			get
			{
				if(_componentInspectionReportGearbox==null)
				{
					...
					_componentInspectionReportGearbox.SetContainingEntityInfo(this, "GearboxManufacturer");
				}
		...
		public virtual EntityCollection<ComponentInspectionReportGeneralEntity> ComponentInspectionReportGeneral
		{
			get
			{
				if(_componentInspectionReportGeneral==null)
				{
					...
					_componentInspectionReportGeneral.SetContainingEntityInfo(this, "GearboxManufacturer");
				}
				return _componentInspectionReportGeneral;
			}
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'GearboxManufacturerEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(GearboxManufacturerEntity))]
		public virtual EntityCollection<GearboxManufacturerEntity> GearboxManufacturer_
		{
			get
			{
				if(_gearboxManufacturer_==null)
				{
					_gearboxManufacturer_ = new EntityCollection<GearboxManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearboxManufacturerEntityFactory)));
					_gearboxManufacturer_.SetContainingEntityInfo(this, "GearboxManufacturer");
				}
				return _gearboxManufacturer_;
			}
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'GearboxTypeEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(GearboxTypeEntity))]
		public virtual EntityCollection<GearboxTypeEntity> GearboxType
		{
			get
			{
				if(_gearboxType==null)
				{
					_gearboxType = new EntityCollection<GearboxTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearboxTypeEntityFactory)));
					_gearboxType.SetContainingEntityInfo(this, "GearboxManufacturer");
				}
				return _gearboxType;
			}
		}
		...
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(GearboxTypeEntity))]
		public virtual EntityCollection<GearboxTypeEntity> GearboxTypeCollectionViaGearboxType
		{
			get
			{
				if(_gearboxTypeCollectionViaGearboxType==null)
				{
					_gearboxTypeCollectionViaGearboxType = new EntityCollection<GearboxTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GearboxTypeEntityFactory)));
					_gearboxTypeCollectionViaGearboxType.IsReadOnly=true;
				}
				return _gearboxTypeCollectionViaGearboxType;
			}
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_gearboxManufacturer != null)
						{
							_gearboxManufacturer.UnsetRelatedEntity(this, "GearboxManufacturer_");
						}
					}
					else
					{
						((IEntity2)value).SetRelatedEntity(this, "GearboxManufacturer_");
					}
				}
			}
		}
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.GearboxManufacturerEntity; }
		}
		#endregion
