...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'TurbineSmallGenerator'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class TurbineSmallGeneratorEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static TurbineSmallGeneratorEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public TurbineSmallGeneratorEntity():base("TurbineSmallGeneratorEntity")
		{
		...
		public TurbineSmallGeneratorEntity(IEntityFields2 fields):base("TurbineSmallGeneratorEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this TurbineSmallGeneratorEntity</param>
		public TurbineSmallGeneratorEntity(IValidator validator):base("TurbineSmallGeneratorEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="turbineSmallGeneratorId">PK value for TurbineSmallGenerator which data should be fetched into this TurbineSmallGenerator object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TurbineSmallGeneratorEntity(System.Int64 turbineSmallGeneratorId):base("TurbineSmallGeneratorEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.TurbineSmallGeneratorId = turbineSmallGeneratorId;
		}
		...
		/// <param name="validator">The custom validator object for this TurbineSmallGeneratorEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TurbineSmallGeneratorEntity(System.Int64 turbineSmallGeneratorId, IValidator validator):base("TurbineSmallGeneratorEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.TurbineSmallGeneratorId = turbineSmallGeneratorId;
		}
		...
		protected TurbineSmallGeneratorEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((TurbineSmallGeneratorFieldIndex)fieldIndex)
			{
				default:
		...
		public bool TestOriginalFieldValueForNull(TurbineSmallGeneratorFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(TurbineSmallGeneratorFieldIndex fieldIndex)
		{
		...
		{
			return new TurbineSmallGeneratorRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoTurbineMatrix()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TurbineMatrixFields.TurbineSmallGeneratorId, null, ComparisonOperator.Equal, this.TurbineSmallGeneratorId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(TurbineSmallGeneratorEntity.Relations.TurbineMatrixEntityUsingTurbineSmallGeneratorId, "TurbineSmallGeneratorEntity__", "TurbineMatrix_", JoinHint.None);
			bucket.Relations.Add(TurbineMatrixEntity.Relations.TurbineEntityUsingTurbineId, "TurbineMatrix_", string.Empty, JoinHint.None);
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TurbineSmallGeneratorFields.TurbineSmallGeneratorId, null, ComparisonOperator.Equal, this.TurbineSmallGeneratorId, "TurbineSmallGeneratorEntity__"));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(TurbineSmallGeneratorEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this TurbineSmallGeneratorEntity</param>
		...
		public  static TurbineSmallGeneratorRelations Relations
		{
			get	{ return new TurbineSmallGeneratorRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineMatrix
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<TurbineMatrixEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineMatrixEntityFactory))),
					TurbineSmallGeneratorEntity.Relations.TurbineMatrixEntityUsingTurbineSmallGeneratorId, 
					(int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineMatrixEntity, 0, null, null, null, null, "TurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineCollectionViaTurbineMatrix
		{
			get
			{
				...
				IEntityRelation intermediateRelation = TurbineSmallGeneratorEntity.Relations.TurbineMatrixEntityUsingTurbineSmallGeneratorId;
				intermediateRelation.SetAliases(string.Empty, "TurbineMatrix_");
				relations.Add(TurbineSmallGeneratorEntity.Relations.TurbineMatrixEntityUsingTurbineSmallGeneratorId, "TurbineSmallGeneratorEntity__", "TurbineMatrix_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineEntity, 0, null, null, relations, null, "TurbineCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineFrequencyCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineFrequencyEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineFrequencyEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, 0, null, null, relations, null, "TurbineFrequencyCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineManufacturerCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineManufacturerEntity, 0, null, null, relations, null, "TurbineManufacturerCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineMarkVersionCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineMarkVersionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineMarkVersionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineMarkVersionEntity, 0, null, null, relations, null, "TurbineMarkVersionCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineNominelPowerCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineNominelPowerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineNominelPowerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineNominelPowerEntity, 0, null, null, relations, null, "TurbineNominelPowerCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineOldCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineOldEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineOldEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, 0, null, null, relations, null, "TurbineOldCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbinePlacementCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbinePlacementEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbinePlacementEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, 0, null, null, relations, null, "TurbinePlacementCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbinePowerRegulationCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbinePowerRegulationEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbinePowerRegulationEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, 0, null, null, relations, null, "TurbinePowerRegulationCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineRotorDiameterCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineRotorDiameterEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineRotorDiameterEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, 0, null, null, relations, null, "TurbineRotorDiameterCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineTemperatureVariantCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineTemperatureVariantEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineTemperatureVariantEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, 0, null, null, relations, null, "TurbineTemperatureVariantCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineVoltageCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineVoltageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineVoltageEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineVoltageEntity, 0, null, null, relations, null, "TurbineVoltageCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return TurbineSmallGeneratorEntity.CustomProperties;}
		}
		...
		{
			get { return TurbineSmallGeneratorEntity.FieldsCustomProperties;}
		}

		/// <summary> The TurbineSmallGeneratorId property of the Entity TurbineSmallGenerator<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineSmallGenerator"."TurbineSmallGeneratorId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 TurbineSmallGeneratorId
		{
			get { return (System.Int64)GetValue((int)TurbineSmallGeneratorFieldIndex.TurbineSmallGeneratorId, true); }
			set	{ SetValue((int)TurbineSmallGeneratorFieldIndex.TurbineSmallGeneratorId, value); }
		}

		/// <summary> The SmallGenerator property of the Entity TurbineSmallGenerator<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineSmallGenerator"."SmallGenerator"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 SmallGenerator
		{
			get { return (System.Int32)GetValue((int)TurbineSmallGeneratorFieldIndex.SmallGenerator, true); }
			set	{ SetValue((int)TurbineSmallGeneratorFieldIndex.SmallGenerator, value); }
		}

		/// <summary> The Created property of the Entity TurbineSmallGenerator<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineSmallGenerator"."Created"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime Created
		{
			get { return (System.DateTime)GetValue((int)TurbineSmallGeneratorFieldIndex.Created, true); }
			set	{ SetValue((int)TurbineSmallGeneratorFieldIndex.Created, value); }
		}

		/// <summary> The CreatedBy property of the Entity TurbineSmallGenerator<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineSmallGenerator"."CreatedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String CreatedBy
		{
			get { return (System.String)GetValue((int)TurbineSmallGeneratorFieldIndex.CreatedBy, true); }
			set	{ SetValue((int)TurbineSmallGeneratorFieldIndex.CreatedBy, value); }
		}

		/// <summary> The Deleted property of the Entity TurbineSmallGenerator<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineSmallGenerator"."Deleted"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> Deleted
		{
			get { return (Nullable<System.DateTime>)GetValue((int)TurbineSmallGeneratorFieldIndex.Deleted, false); }
			set	{ SetValue((int)TurbineSmallGeneratorFieldIndex.Deleted, value); }
		}

		/// <summary> The DeletedBy property of the Entity TurbineSmallGenerator<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineSmallGenerator"."DeletedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String DeletedBy
		{
			get { return (System.String)GetValue((int)TurbineSmallGeneratorFieldIndex.DeletedBy, true); }
			set	{ SetValue((int)TurbineSmallGeneratorFieldIndex.DeletedBy, value); }
		}
		...
		public virtual EntityCollection<TurbineMatrixEntity> TurbineMatrix
		{
			get
			{
				if(_turbineMatrix==null)
				{
					...
					_turbineMatrix.SetContainingEntityInfo(this, "TurbineSmallGenerator");
				}
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity; }
		}
		#endregion
