...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'GeneratorDriveEnd'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class GeneratorDriveEndEntity : CommonEntityBase, ISerializable
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfaces
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private EntityCollection<ComponentInspectionReportGeneratorEntity> _componentInspectionReportGenerator;
		private EntityCollection<GeneratorDriveEndEntity> _generatorDriveEnd_;
		...
		public static class MemberNames
		{
			...
			/// <summary>Member name GeneratorDriveEnd_</summary>
			public static readonly string GeneratorDriveEnd_ = "GeneratorDriveEnd_";
		...
		static GeneratorDriveEndEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public GeneratorDriveEndEntity():base("GeneratorDriveEndEntity")
		{
		...
		public GeneratorDriveEndEntity(IEntityFields2 fields):base("GeneratorDriveEndEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this GeneratorDriveEndEntity</param>
		public GeneratorDriveEndEntity(IValidator validator):base("GeneratorDriveEndEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="generatorDriveEndId">PK value for GeneratorDriveEnd which data should be fetched into this GeneratorDriveEnd object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public GeneratorDriveEndEntity(System.Int64 generatorDriveEndId):base("GeneratorDriveEndEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.GeneratorDriveEndId = generatorDriveEndId;
		}
		...
		/// <param name="validator">The custom validator object for this GeneratorDriveEndEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public GeneratorDriveEndEntity(System.Int64 generatorDriveEndId, IValidator validator):base("GeneratorDriveEndEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.GeneratorDriveEndId = generatorDriveEndId;
		}
		...
		protected GeneratorDriveEndEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_generatorDriveEnd_ = (EntityCollection<GeneratorDriveEndEntity>)info.GetValue("_generatorDriveEnd_", typeof(EntityCollection<GeneratorDriveEndEntity>));
		...
		{
			switch((GeneratorDriveEndFieldIndex)fieldIndex)
			{
				case GeneratorDriveEndFieldIndex.ParentGeneratorDriveEndId:
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				...
				case "ComponentInspectionReportGenerator":
					...
					break;
				case "GeneratorDriveEnd_":
					this.GeneratorDriveEnd_.Add((GeneratorDriveEndEntity)entity);
					break;
		...
		public override void SetRelatedEntity(IEntity2 relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				...
				case "ComponentInspectionReportGenerator":
					...
					break;
				case "GeneratorDriveEnd_":
					this.GeneratorDriveEnd_.Add((GeneratorDriveEndEntity)relatedEntity);
					OnRelatedEntitySet(relatedEntity, fieldName);
					break;
		...
		public override void UnsetRelatedEntity(IEntity2 relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				...
				case "ComponentInspectionReportGenerator":
					...
					break;
				case "GeneratorDriveEnd_":
					base.PerformRelatedEntityRemoval(this.GeneratorDriveEnd_, relatedEntity, signalRelatedEntityManyToOne);
					OnRelatedEntityUnset(relatedEntity, fieldName);
					break;
		...
		public override List<IEntityCollection2> GetMemberEntityCollections()
		{
			...
			toReturn.Add(this.GeneratorDriveEnd_);
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_generatorDriveEnd_", ((_generatorDriveEnd_!=null) && (_generatorDriveEnd_.Count>0) && !this.MarkedForDeletion)?_generatorDriveEnd_:null);
		...
		public bool TestOriginalFieldValueForNull(GeneratorDriveEndFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(GeneratorDriveEndFieldIndex fieldIndex)
		{
		...
		{
			return new GeneratorDriveEndRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoComponentInspectionReportGenerator()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ComponentInspectionReportGeneratorFields.GeneratorDriveEndId, null, ComparisonOperator.Equal, this.GeneratorDriveEndId));
			return bucket;
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoGeneratorDriveEnd_()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(GeneratorDriveEndFields.ParentGeneratorDriveEndId, null, ComparisonOperator.Equal, this.GeneratorDriveEndId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(GeneratorDriveEndEntity.Relations.ComponentInspectionReportGeneratorEntityUsingGeneratorDriveEndId, "GeneratorDriveEndEntity__", "ComponentInspectionReportGenerator_", JoinHint.None);
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(GeneratorDriveEndFields.GeneratorDriveEndId, null, ComparisonOperator.Equal, this.GeneratorDriveEndId, "GeneratorDriveEndEntity__"));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(GeneratorDriveEndFields.GeneratorDriveEndId, null, ComparisonOperator.Equal, this.ParentGeneratorDriveEndId));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(GeneratorDriveEndEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._generatorDriveEnd_);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._generatorDriveEnd_ = (EntityCollection<GeneratorDriveEndEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			if (this._generatorDriveEnd_ != null)
			{
				return true;
			}
		...
		public override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("GeneratorDriveEnd_", _generatorDriveEnd_);
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_generatorDriveEnd_!=null)
			{
				_generatorDriveEnd_.ActiveContext = base.ActiveContext;
			}
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ParentGeneratorDriveEndId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			base.PerformDesetupSyncRelatedEntity( _generatorDriveEnd, new PropertyChangedEventHandler( OnGeneratorDriveEndPropertyChanged ), "GeneratorDriveEnd", GeneratorDriveEndEntity.Relations.GeneratorDriveEndEntityUsingGeneratorDriveEndIdParentGeneratorDriveEndId, true, signalRelatedEntity, "GeneratorDriveEnd_", resetFKFields, new int[] { (int)GeneratorDriveEndFieldIndex.ParentGeneratorDriveEndId } );		
			_generatorDriveEnd = null;
		}
		...
		private void SetupSyncGeneratorDriveEnd(IEntity2 relatedEntity)
		{
			...
			base.PerformSetupSyncRelatedEntity( _generatorDriveEnd, new PropertyChangedEventHandler( OnGeneratorDriveEndPropertyChanged ), "GeneratorDriveEnd", GeneratorDriveEndEntity.Relations.GeneratorDriveEndEntityUsingGeneratorDriveEndIdParentGeneratorDriveEndId, true, new string[] {  } );
		}
		...
		/// <param name="validator">The validator object for this GeneratorDriveEndEntity</param>
		...
		public  static GeneratorDriveEndRelations Relations
		{
			get	{ return new GeneratorDriveEndRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportGenerator
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ComponentInspectionReportGeneratorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportGeneratorEntityFactory))),
					GeneratorDriveEndEntity.Relations.ComponentInspectionReportGeneratorEntityUsingGeneratorDriveEndId, 
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportGeneratorEntity, 0, null, null, null, null, "ComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		/// for this entity. Add the object returned by this property to an existing PrefetchPath2 instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathGeneratorDriveEnd_
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<GeneratorDriveEndEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorDriveEndEntityFactory))),
					GeneratorDriveEndEntity.Relations.GeneratorDriveEndEntityUsingParentGeneratorDriveEndId, 
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, 0, null, null, null, null, "GeneratorDriveEnd_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathActionToBeTakenOnGeneratorCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				IEntityRelation intermediateRelation = GeneratorDriveEndEntity.Relations.ComponentInspectionReportGeneratorEntityUsingGeneratorDriveEndId;
				intermediateRelation.SetAliases(string.Empty, "ComponentInspectionReportGenerator_");
				relations.Add(GeneratorDriveEndEntity.Relations.ComponentInspectionReportGeneratorEntityUsingGeneratorDriveEndId, "GeneratorDriveEndEntity__", "ComponentInspectionReportGenerator_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<ActionToBeTakenOnGeneratorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ActionToBeTakenOnGeneratorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.ActionToBeTakenOnGeneratorEntity, 0, null, null, relations, null, "ActionToBeTakenOnGeneratorCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBooleanAnswerCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<BooleanAnswerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BooleanAnswerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.BooleanAnswerEntity, 0, null, null, relations, null, "BooleanAnswerCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComponentInspectionReportCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ComponentInspectionReportEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ComponentInspectionReportEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.ComponentInspectionReportEntity, 0, null, null, relations, null, "ComponentInspectionReportCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCouplingCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CouplingEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CouplingEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.CouplingEntity, 0, null, null, relations, null, "CouplingCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGeneratorCoverCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GeneratorCoverEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorCoverEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.GeneratorCoverEntity, 0, null, null, relations, null, "GeneratorCoverCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGeneratorManufacturerCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GeneratorManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.GeneratorManufacturerEntity, 0, null, null, relations, null, "GeneratorManufacturerCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGeneratorNonDriveEndCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GeneratorNonDriveEndEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorNonDriveEndEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.GeneratorNonDriveEndEntity, 0, null, null, relations, null, "GeneratorNonDriveEndCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGeneratorRotorCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<GeneratorRotorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorRotorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.GeneratorRotorEntity, 0, null, null, relations, null, "GeneratorRotorCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator______
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator______", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator_____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator_____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator_______
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator_______", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator____
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator_
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator___
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator___", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOhmUnitCollectionViaComponentInspectionReportGenerator__
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OhmUnitEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OhmUnitEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.OhmUnitEntity, 0, null, null, relations, null, "OhmUnitCollectionViaComponentInspectionReportGenerator__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathGeneratorDriveEnd
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorDriveEndEntityFactory))),
					GeneratorDriveEndEntity.Relations.GeneratorDriveEndEntityUsingGeneratorDriveEndIdParentGeneratorDriveEndId, 
					(int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, (int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity, 0, null, null, null, null, "GeneratorDriveEnd", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return GeneratorDriveEndEntity.CustomProperties;}
		}
		...
		{
			get { return GeneratorDriveEndEntity.FieldsCustomProperties;}
		}

		/// <summary> The GeneratorDriveEndId property of the Entity GeneratorDriveEnd<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "GeneratorDriveEnd"."GeneratorDriveEndId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 GeneratorDriveEndId
		{
			get { return (System.Int64)GetValue((int)GeneratorDriveEndFieldIndex.GeneratorDriveEndId, true); }
			set	{ SetValue((int)GeneratorDriveEndFieldIndex.GeneratorDriveEndId, value); }
		}

		/// <summary> The Name property of the Entity GeneratorDriveEnd<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "GeneratorDriveEnd"."Name"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)GeneratorDriveEndFieldIndex.Name, true); }
			set	{ SetValue((int)GeneratorDriveEndFieldIndex.Name, value); }
		}

		/// <summary> The LanguageId property of the Entity GeneratorDriveEnd<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "GeneratorDriveEnd"."LanguageId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 LanguageId
		{
			get { return (System.Int64)GetValue((int)GeneratorDriveEndFieldIndex.LanguageId, true); }
			set	{ SetValue((int)GeneratorDriveEndFieldIndex.LanguageId, value); }
		}

		/// <summary> The ParentGeneratorDriveEndId property of the Entity GeneratorDriveEnd<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "GeneratorDriveEnd"."ParentGeneratorDriveEndId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> ParentGeneratorDriveEndId
		{
			get { return (Nullable<System.Int64>)GetValue((int)GeneratorDriveEndFieldIndex.ParentGeneratorDriveEndId, false); }
			set	{ SetValue((int)GeneratorDriveEndFieldIndex.ParentGeneratorDriveEndId, value); }
		}

		/// <summary> The Sort property of the Entity GeneratorDriveEnd<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "GeneratorDriveEnd"."Sort"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 Sort
		{
			get { return (System.Int64)GetValue((int)GeneratorDriveEndFieldIndex.Sort, true); }
			set	{ SetValue((int)GeneratorDriveEndFieldIndex.Sort, value); }
		}
		...
		public virtual EntityCollection<ComponentInspectionReportGeneratorEntity> ComponentInspectionReportGenerator
		{
			get
			{
				if(_componentInspectionReportGenerator==null)
				{
					...
					_componentInspectionReportGenerator.SetContainingEntityInfo(this, "GeneratorDriveEnd");
				}
				return _componentInspectionReportGenerator;
			}
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'GeneratorDriveEndEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(GeneratorDriveEndEntity))]
		public virtual EntityCollection<GeneratorDriveEndEntity> GeneratorDriveEnd_
		{
			get
			{
				if(_generatorDriveEnd_==null)
				{
					_generatorDriveEnd_ = new EntityCollection<GeneratorDriveEndEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GeneratorDriveEndEntityFactory)));
					_generatorDriveEnd_.SetContainingEntityInfo(this, "GeneratorDriveEnd");
				}
				return _generatorDriveEnd_;
			}
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_generatorDriveEnd != null)
						{
							_generatorDriveEnd.UnsetRelatedEntity(this, "GeneratorDriveEnd_");
						}
					}
					else
					{
						((IEntity2)value).SetRelatedEntity(this, "GeneratorDriveEnd_");
					}
				}
			}
		}
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.GeneratorDriveEndEntity; }
		}
		#endregion
