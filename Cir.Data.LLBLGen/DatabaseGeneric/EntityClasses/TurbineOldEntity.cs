...
namespace Cir.Data.LLBLGen.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'TurbineOld'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class TurbineOldEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static TurbineOldEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public TurbineOldEntity():base("TurbineOldEntity")
		{
		...
		public TurbineOldEntity(IEntityFields2 fields):base("TurbineOldEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this TurbineOldEntity</param>
		public TurbineOldEntity(IValidator validator):base("TurbineOldEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="turbineOldId">PK value for TurbineOld which data should be fetched into this TurbineOld object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TurbineOldEntity(System.Int64 turbineOldId):base("TurbineOldEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.TurbineOldId = turbineOldId;
		}
		...
		/// <param name="validator">The custom validator object for this TurbineOldEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TurbineOldEntity(System.Int64 turbineOldId, IValidator validator):base("TurbineOldEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.TurbineOldId = turbineOldId;
		}
		...
		protected TurbineOldEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((TurbineOldFieldIndex)fieldIndex)
			{
				default:
		...
		public bool TestOriginalFieldValueForNull(TurbineOldFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(TurbineOldFieldIndex fieldIndex)
		{
		...
		{
			return new TurbineOldRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoTurbineMatrix()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TurbineMatrixFields.TurbineOldId, null, ComparisonOperator.Equal, this.TurbineOldId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.Add(TurbineOldEntity.Relations.TurbineMatrixEntityUsingTurbineOldId, "TurbineOldEntity__", "TurbineMatrix_", JoinHint.None);
			bucket.Relations.Add(TurbineMatrixEntity.Relations.TurbineEntityUsingTurbineId, "TurbineMatrix_", string.Empty, JoinHint.None);
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TurbineOldFields.TurbineOldId, null, ComparisonOperator.Equal, this.TurbineOldId, "TurbineOldEntity__"));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Cir.Data.LLBLGen.EntityType.TurbineOldEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(TurbineOldEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("Turbine", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this TurbineOldEntity</param>
		...
		public  static TurbineOldRelations Relations
		{
			get	{ return new TurbineOldRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineMatrix
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<TurbineMatrixEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineMatrixEntityFactory))),
					TurbineOldEntity.Relations.TurbineMatrixEntityUsingTurbineOldId, 
					(int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineMatrixEntity, 0, null, null, null, null, "TurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineCollectionViaTurbineMatrix
		{
			get
			{
				...
				IEntityRelation intermediateRelation = TurbineOldEntity.Relations.TurbineMatrixEntityUsingTurbineOldId;
				intermediateRelation.SetAliases(string.Empty, "TurbineMatrix_");
				relations.Add(TurbineOldEntity.Relations.TurbineMatrixEntityUsingTurbineOldId, "TurbineOldEntity__", "TurbineMatrix_", JoinHint.None);
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineEntity, 0, null, null, relations, null, "TurbineCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineFrequencyCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineFrequencyEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineFrequencyEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineFrequencyEntity, 0, null, null, relations, null, "TurbineFrequencyCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineManufacturerCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineManufacturerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineManufacturerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineManufacturerEntity, 0, null, null, relations, null, "TurbineManufacturerCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineMarkVersionCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineMarkVersionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineMarkVersionEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineMarkVersionEntity, 0, null, null, relations, null, "TurbineMarkVersionCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineNominelPowerCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineNominelPowerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineNominelPowerEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineNominelPowerEntity, 0, null, null, relations, null, "TurbineNominelPowerCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbinePlacementCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbinePlacementEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbinePlacementEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, (int)Cir.Data.LLBLGen.EntityType.TurbinePlacementEntity, 0, null, null, relations, null, "TurbinePlacementCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbinePowerRegulationCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbinePowerRegulationEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbinePowerRegulationEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, (int)Cir.Data.LLBLGen.EntityType.TurbinePowerRegulationEntity, 0, null, null, relations, null, "TurbinePowerRegulationCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineRotorDiameterCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineRotorDiameterEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineRotorDiameterEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineRotorDiameterEntity, 0, null, null, relations, null, "TurbineRotorDiameterCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineSmallGeneratorCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineSmallGeneratorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineSmallGeneratorEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineSmallGeneratorEntity, 0, null, null, relations, null, "TurbineSmallGeneratorCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineTemperatureVariantCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineTemperatureVariantEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineTemperatureVariantEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineTemperatureVariantEntity, 0, null, null, relations, null, "TurbineTemperatureVariantCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTurbineVoltageCollectionViaTurbineMatrix
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TurbineVoltageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TurbineVoltageEntityFactory))),	intermediateRelation,
					(int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity, (int)Cir.Data.LLBLGen.EntityType.TurbineVoltageEntity, 0, null, null, relations, null, "TurbineVoltageCollectionViaTurbineMatrix", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return TurbineOldEntity.CustomProperties;}
		}
		...
		{
			get { return TurbineOldEntity.FieldsCustomProperties;}
		}

		/// <summary> The TurbineOldId property of the Entity TurbineOld<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineOld"."TurbineOldId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 TurbineOldId
		{
			get { return (System.Int64)GetValue((int)TurbineOldFieldIndex.TurbineOldId, true); }
			set	{ SetValue((int)TurbineOldFieldIndex.TurbineOldId, value); }
		}

		/// <summary> The Turbine property of the Entity TurbineOld<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineOld"."Turbine"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Turbine
		{
			get { return (System.String)GetValue((int)TurbineOldFieldIndex.Turbine, true); }
			set	{ SetValue((int)TurbineOldFieldIndex.Turbine, value); }
		}

		/// <summary> The Created property of the Entity TurbineOld<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineOld"."Created"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime Created
		{
			get { return (System.DateTime)GetValue((int)TurbineOldFieldIndex.Created, true); }
			set	{ SetValue((int)TurbineOldFieldIndex.Created, value); }
		}

		/// <summary> The CreatedBy property of the Entity TurbineOld<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineOld"."CreatedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String CreatedBy
		{
			get { return (System.String)GetValue((int)TurbineOldFieldIndex.CreatedBy, true); }
			set	{ SetValue((int)TurbineOldFieldIndex.CreatedBy, value); }
		}

		/// <summary> The Deleted property of the Entity TurbineOld<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineOld"."Deleted"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> Deleted
		{
			get { return (Nullable<System.DateTime>)GetValue((int)TurbineOldFieldIndex.Deleted, false); }
			set	{ SetValue((int)TurbineOldFieldIndex.Deleted, value); }
		}

		/// <summary> The DeletedBy property of the Entity TurbineOld<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TurbineOld"."DeletedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String DeletedBy
		{
			get { return (System.String)GetValue((int)TurbineOldFieldIndex.DeletedBy, true); }
			set	{ SetValue((int)TurbineOldFieldIndex.DeletedBy, value); }
		}
		...
		public virtual EntityCollection<TurbineMatrixEntity> TurbineMatrix
		{
			get
			{
				if(_turbineMatrix==null)
				{
					...
					_turbineMatrix.SetContainingEntityInfo(this, "TurbineOld");
				}
		...
		{ 
			get { return (int)Cir.Data.LLBLGen.EntityType.TurbineOldEntity; }
		}
		#endregion
