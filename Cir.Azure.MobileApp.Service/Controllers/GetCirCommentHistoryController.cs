...
namespace Cir.Azure.MobileApp.Service.Controllers
{
    ...
    {        
        ...
        public List<Cir.Azure.MobileApp.Service.CirSyncService.CirCommentHistorys> POST(Cir.Azure.MobileApp.Service.CirSyncService.CirCommentHistorys CirCommentHistory)
        {
            List<Cir.Azure.MobileApp.Service.CirSyncService.CirCommentHistorys> oResponse;
