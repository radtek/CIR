   ...
   // [AuthorizeAadRole(Roles = "Administrator")]
    public class ManufacturerController : ApiController
    {
       ...
       // [AuthorizeAadRole(Roles = "Administrator")]
        ...
        public Cir.Azure.MobileApp.Service.CirSyncService.Manufacturer Get(int type, int id)
        {
            try
            {
       ...
       // [AuthorizeAadRole(Roles = "Administrator")]
        ...
        public Cir.Azure.MobileApp.Service.CirSyncService.ManufacturerList Get(int type)
        {
            try
            {
       ...
       // [AuthorizeAadRole(Roles = "Administrator")]
        [HttpPost]    
        public bool Post(Cir.Azure.MobileApp.Service.CirSyncService.Manufacturer m)
        {
            try
            {
