...
namespace Cir.Azure.MobileApp.Service.Controllers
{
   ...
   // [AuthorizeAadRole(Roles = "*")]
    public class FeedbackController : ApiController
    {
        ...
        /// // [AuthorizeAadRole(Roles = "*")]
        public Cir.Azure.MobileApp.Service.CirSyncService.Feedback Post(Cir.Azure.MobileApp.Service.CirSyncService.Feedback lstFeedback)
        {
            Cir.Azure.MobileApp.Service.CirSyncService.Feedback oResponse;
        ...
        public List<Cir.Azure.MobileApp.Service.CirSyncService.Feedback> Get()
        {
