...
namespace Cir.Azure.MobileApp.Service.Controllers
{
   ...
   // [AuthorizeAadRole(Roles = "*")]
    public class MasterDataController : ApiController
    {
        ...
        public System.Collections.Generic.List<Cir.Azure.MobileApp.Service.CirSyncService.CirMasterData> Get()
        {
            try
            {
        ...
        public System.Collections.Generic.List<Cir.Azure.MobileApp.Service.CirSyncService.CirMasterTable> GetMasterDataByTable(string TableName)
         {
            try
            {
        ...
        public System.Collections.Generic.List<Cir.Azure.MobileApp.Service.CirSyncService.CirCIMCaseTable> GetCIMCaseTable()
        {
            try
            {
                this.Configuration.Services.GetTraceWriter().Info("Entered MasterData custom controller!");
